...
!
    function(modules) {
        ...
        function(module, exports, __webpack_require__) { (function(global) {
            module.exports = global.$ = __webpack_require__(12)
        ...
        function(module, __webpack_exports__, __webpack_require__) {
            ...
            var __WEBPACK_IMPORTED_MODULE_0_expose_loader_jquery__ = __webpack_require__(11);
        ...
        function(module, exports, __webpack_require__) { (function(global) {
            module.exports = global.jQuery = __webpack_require__(13)
        }).call(exports, __webpack_require__(1))
        },
                ...
                function(global, factory) {
                    ...
                    function(window, noGlobal) {
                        ...
                        function setGlobalEval(elems, refElements) {
                            for (var i = 0,
                                     l = elems.length; i < l; i++) data_priv.set(elems[i], "globalEval", !refElements || data_priv.get(refElements[i], "globalEval"))
                        }
                        ...
                        function defaultDisplay(nodeName) {
                            ...
                            return display || (display = actualDisplay(nodeName, doc), "none" !== display && display || (iframe = (iframe || jQuery("<iframe frameborder='0' width='0' height='0'/>")).appendTo(doc.documentElement), doc = iframe[0].contentDocument, doc.write(), doc.close(), display = actualDisplay(nodeName, doc), iframe.detach()), elemdisplay[nodeName] = display),
                                display
                        }
                        ...
                        function defaultPrefilter(elem, props, opts) {
                            ...
                            1 === elem.nodeType && ("height" in props || "width" in props) && (opts.overflow = [style.overflow, style.overflowX, style.overflowY], display = jQuery.css(elem, "display"), "inline" === ("none" === display ? data_priv.get(elem, "olddisplay") || defaultDisplay(elem.nodeName) : display) && "none" === jQuery.css(elem, "float") && (style.display = "inline-block")),
                        ...
                        jQuery.fn = jQuery.prototype = {
                            ...
                            jQuery.extend({
                                ...
                                globalEval: function(code) {
                                    var script, indirect = eval; (code = jQuery.trim(code)) && (1 === code.indexOf("use strict") ? (script = document.createElement("script"), script.text = code, document.head.appendChild(script).parentNode.removeChild(script)) : indirect(code))
                                },
                                ...
                                merge: function(first, second) {
                                    for (var len = +second.length,
                                             j = 0,
                                             i = first.length; j < len; j++) first[i++] = second[j];
                        ...
                        var Sizzle = function(window) {
                            ...
                            function toSelector(tokens) {
                                for (var i = 0,
                                         len = tokens.length,
                                         selector = ""; i < len; i++) selector += tokens[i].value;
                                return selector
                            }
                            ...
                            function multipleContexts(selector, contexts, results) {
                                for (var i = 0,
                                         len = contexts.length; i < len; i++) Sizzle(selector, contexts[i], results);
                                return results
                            }
                            ...
                            function matcherFromTokens(tokens) {
                                for (var checkContext, matcher, j, len = tokens.length,
                                        ...
                                        return checkContext = null,
                                            ret
                                    }]; i < len; i++) if (matcher = Expr.relative[tokens[i].type]) matchers = [addCombinator(elementMatcher(matchers), matcher)];
                                else {
                            ...
                            var i, support, Expr, getText, isXML, tokenize, compile, select, outermostContext, sortInput, hasDuplicate, setDocument, document, docElem, documentIsHTML, rbuggyQSA, rbuggyMatches, matches, contains, expando = "sizzle" + 1 * new Date,
                                ...
                                indexOf = function(list, elem) {
                                    for (var i = 0,
                                             len = list.length; i < len; i++) if (list[i] === elem) return i;
                                    return - 1
                                },
                        ...
                        var rootjQuery, rquickExpr = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/; (jQuery.fn.init = function(selector, context) {
                            var match, elem;
                        ...
                        jQuery.extend({
                            ...
                            jQuery.fn.extend({
                                ...
                                closest: function(selectors, context) {
                                    for (var cur, i = 0,
                                             l = this.length,
                                             matched = [], pos = rneedsContext.test(selectors) || "string" != typeof selectors ? jQuery(selectors, context || this.context) : 0; i < l; i++) for (cur = this[i]; cur && cur !== context; cur = cur.parentNode) if (cur.nodeType < 11 && (pos ? pos.index(cur) > -1 : 1 === cur.nodeType && jQuery.find.matchesSelector(cur, selectors))) {
                                        matched.push(cur);
                                        break
                                    }
                        ...
                        jQuery.fn.ready = function(fn) {
                            ...
                            jQuery.extend({
                                ...
                                ready: function(wait) { (!0 === wait ? --jQuery.readyWait: jQuery.isReady) || (jQuery.isReady = !0, !0 !== wait && --jQuery.readyWait > 0 || (readyList.resolveWith(document, [jQuery]), jQuery.fn.triggerHandler && (jQuery(document).triggerHandler("ready"), jQuery(document).off("ready"))))
                                }
                            }),
                            ...
                            Data.prototype = {
                                ...
                                remove: function(owner, key) {
                                    ...
                                    if (void 0 === key) this.cache[unlock] = {};
                                        ...
                                        jQuery.isArray(key) ? name = key.concat(key.map(jQuery.camelCase)) : (camel = jQuery.camelCase(key), key in cache ? name = [key, camel] : (name = camel, name = name in cache ? [name] : name.match(rnotwhite) || [])),
                                            i = name.length;
                        ...
                        jQuery.event = {
                            ...
                            trigger: function(event, data, elem, onlyHandlers) {
                                ...
                                onlyHandlers || !special.trigger || !1 !== special.trigger.apply(elem, data))) {
                                    ...
                                    onlyHandlers || event.isDefaultPrevented() || special._default && !1 !== special._default.apply(eventPath.pop(), data) || !jQuery.acceptData(elem) || ontype && jQuery.isFunction(elem[type]) && !jQuery.isWindow(elem) && (tmp = elem[ontype], tmp && (elem[ontype] = null), jQuery.event.triggered = type, elem[type](), jQuery.event.triggered = void 0, tmp && (elem[ontype] = tmp)),
                                        event.result
                                }
                            },
                        ...
                        wrapMap.optgroup = wrapMap.option,
                            ...
                            jQuery.extend({
                                ...
                                buildFragment: function(elems, context, scripts, selection) {
                                    for (var elem, tmp, tag, wrap, contains, j, fragment = context.createDocumentFragment(), nodes = [], i = 0, l = elems.length; i < l; i++) if ((elem = elems[i]) || 0 === elem) if ("object" === jQuery.type(elem)) jQuery.merge(nodes, elem.nodeType ? [elem] : elem);
                                ...
                                cleanData: function(elems) {
                                    for (var data, elem, type, key, special = jQuery.event.special,
                                             i = 0; void 0 !== (elem = elems[i]); i++) {
                            ...
                            jQuery.fn.extend({
                                ...
                                domManip: function(args, callback) {
                                    ...
                                    if (l && (fragment = jQuery.buildFragment(args, this[0].ownerDocument, !1, this), first = fragment.firstChild, 1 === fragment.childNodes.length && (fragment = first), first)) {
                                        ...
                                        if (hasScripts) for (doc = scripts[scripts.length - 1].ownerDocument, jQuery.map(scripts, restoreScript), i = 0; i < hasScripts; i++) node = scripts[i],
                        ...
                        jQuery.extend({
                            ...
                            style: function(elem, name, value, extra) {
                                if (elem && 3 !== elem.nodeType && 8 !== elem.nodeType && elem.style) {
                                    ...
                                    null != value && value === value && ("number" !== type || jQuery.cssNumber[origName] || (value += "px"), support.clearCloneStyle || "" !== value || 0 !== name.indexOf("background") || (style[name] = "inherit"), hooks && "set" in hooks && void 0 === (value = hooks.set(elem, value, extra)) || (style[name] = value))
                                }
                            },
                                ...
                                function(i, name) {
                                    jQuery.cssHooks[name] = {
                                        get: function(elem, computed, extra) {
                                            if (computed) return rdisplayswap.test(jQuery.css(elem, "display")) && 0 === elem.offsetWidth ? jQuery.swap(elem, cssShow,
                                                function() {
                        ...
                        jQuery.Animation = jQuery.extend(Animation, {
                            tweener: function(props, callback) {
                                ...
                                for (var prop, index = 0,
                                         length = props.length; index < length; index++) prop = props[index],
                                    ...
                                    var empty = jQuery.isEmptyObject(prop),
                                        ...
                                        doAnimation = function() {
                                            var anim = Animation(this, jQuery.extend({},
                                                prop), optall); (empty || data_priv.get(this, "finish")) && anim.stop(!0)
                                        };
                            ...
                            jQuery.each(jQuery.expr.match.bool.source.match(/\w+/g),
                                function(i, name) {
                                    ...
                                    attrHandle[name] = function(elem, name, isXML) {
                                        var ret, handle;
                                        return isXML || (handle = attrHandle[name], attrHandle[name] = ret, ret = null != getter(elem, name, isXML) ? name.toLowerCase() : null, attrHandle[name] = handle),
                                            ret
                                    }
                                });
                            ...
                            toggleClass: function(value, stateVal) {
                                ...
                                return "boolean" == typeof stateVal && "string" === type ? stateVal ? this.addClass(value) : this.removeClass(value) : jQuery.isFunction(value) ? this.each(function(i) {
                                    ...
                                    if ("string" === type) for (var className, i = 0,
                                                                    self = jQuery(this), classNames = value.match(rnotwhite) || []; className = classNames[i++];) self.hasClass(className) ? self.removeClass(className) : self.addClass(className);
                                    else "undefined" !== type && "boolean" !== type || (this.className && data_priv.set(this, "__className__", this.className), this.className = this.className || !1 === value ? "": data_priv.get(this, "__className__") || "")
                                })
                            },
                            hasClass: function(selector) {
                                for (var className = " " + selector + " ",
                                         i = 0,
                                         l = this.length; i < l; i++) if (1 === this[i].nodeType && (" " + this[i].className + " ").replace(rclass, " ").indexOf(className) >= 0) return ! 0;
                                return ! 1
                            }
                        });
                        var rreturn = /\r/g;
                                    ...
                                    select: {
                                        get: function(elem) {
                                            for (var value, option, options = elem.options,
                                                     ...
                                                     values = one ? null: [], max = one ? index + 1 : options.length, i = index < 0 ? max: one ? index: 0; i < max; i++) if (option = options[i], (option.selected || i === index) && (support.optDisabled ? !option.disabled: null === option.getAttribute("disabled")) && (!option.parentNode.disabled || !jQuery.nodeName(option.parentNode, "optgroup"))) {
                            ...
                            jQuery.fn.extend({
                                offset: function(options) {
                                    ...
                                    if (doc) return docElem = doc.documentElement,
                                        jQuery.contains(docElem, elem) ? (void 0 !== elem.getBoundingClientRect && (box = elem.getBoundingClientRect()), win = getWindow(doc), {
                            ...
                            jQuery.each(["top", "left"],
                                function(i, prop) {
                                    jQuery.cssHooks[prop] = addGetHookIf(support.pixelPosition,
                                        function(elem, computed) {
                                            if (computed) return computed = curCSS(elem, prop),
        ...
        function(module, exports) {
            window.__ctx = "/dfas-common-bpm",
                ...
                window.getCtxUrl = function(url, replaceRequestParam) {
                    return ! url || url.startWith(__ctx) || url.startWith("http") || (url.startWith("/") || (url = "/" + url), url = __ctx + url, replaceRequestParam && -1 != url.indexOf("?") && (url = url.format($.getParams()))),
                        url
                },
                window.getProjectUrl = function(url) {
                    if (url && -1 == url.indexOf("http://") && "/" === url.substring(0, 1)) {
                        ...
                        return - 1 != "/bus,/bpm,/sys,/org,/form,/flow-editor".indexOf(projectPath) ? url: url.startWith(projectPath) ? url: projectPath + url
                    }
                    return url
                }
        },
        ...
        function(module, exports) {
            function daysBetween(DateOne, DateTwo) {
                ...
                if (null != DateOne && "" != DateOne) {
                    ...
                    dayOne = arrOne[0],
                    arrOne.length > 1 && (timeOne = arrOne[1])
                }
                if (null != DateTwo && "" != DateTwo) {
                    var arrTwo = DateTwo.split(" ");
                    dayTwo = arrTwo[0],
                    arrTwo.length > 1 && (timeTwo = arrTwo[1])
                }
                var OneMonth = 0,
                    OneDay = 0,
                    OneYear = 0;
                if (null != dayOne && "" != dayOne) {
                ...
                var TwoHour = 0,
                    TwoMin = 0,
                    TwoSec = 0;
                if (null != timeTwo && "" != timeTwo) {
                    var arrTiem = timeTwo.split(":");
                    TwoHour = parseInt(arrTiem[0]),
                        TwoMin = parseInt(arrTiem[1]),
                        TwoSec = parseInt(arrTiem[2])
                }
                var vflag = TwoYear > OneYear;
                if (!vflag && !(vflag = TwoMonth > OneMonth)) {
                    if (vflag = TwoDay > OneDay) return ! 0;
                    if (OneDay != TwoDay) return ! 1; (vflag = TwoHour > OneHour) || (vflag = TwoMin > OneMin) || (vflag = TwoSec >= OneSec)
                }
                return vflag
            }
            function forbidF5(exp) {
                window.navigator.userAgent.indexOf(exp) >= 0 && (document.onkeydown = function(e) {
                    ...
                    if (116 == (ev.keyCode || ev.which)) return ev.keyCode ? ev.keyCode = 0 : ev.which = 0,
                        cancelBubble = !0,
                        !1
                })
            }
            ...
            jQuery.extend({
                ...
                convertCurrency: function(currencyDigits) {
                    ...
                    if (parts = currencyDigits.split("."), parts.length > 1 ? (integral = parts[0], decimal = parts[1], decimal = decimal.substr(0, 2)) : (integral = parts[0], decimal = ""), digits = new Array("零", "壹", "贰", "叁", "肆", "伍", "陆", "柒", "捌", "玖"), radices = new Array("", "拾", "佰", "仟"), bigRadices = new Array("", "万", "亿"), decimals = new Array("角", "分"), outputCharacters = "", Number(integral) > 0) {
                        for (zeroCount = 0, i = 0; i < integral.length; i++) p = integral.length - i - 1,
                            d = integral.substr(i, 1),
                            quotient = p / 4,
                            modulus = p % 4,
                            "0" == d ? zeroCount++:(zeroCount > 0 && (outputCharacters += digits[0]), zeroCount = 0, outputCharacters += digits[Number(d)] + radices[modulus]),
                ...
                getParams: function() {
                    for (var locUrl = window.location.search.substr(1), aryParams = locUrl.split("&"), json = {},
                             i = 0; i < aryParams.length; i++) {
                ...
                getResult: function(result, fn, errMsgType, sucMsgType, errorFn, isFastJson) {
                    if ("object" != typeof result) if (result.startWith("{") || result.startWith("[")) var result = eval("(" + result + ")");
                    else result = {
                            isOk: !1,
                            msg: "服务器反馈数据格式存在异常，无法解析反馈结果！",
                            cause: result
                        };
                    if (isFastJson && FastJson.format(result), !result.isOk) return errMsgType && "toast" !== errMsgType ? "alert" === errMsgType && $.Dialog.alert(result.msg, 2) : $.Toast.error(result.msg),
                        console.error(result),
                        void(errorFn && errorFn(result));
                    sucMsgType ? "toast" === sucMsgType ? ($.Toast.success(result.msg), fn && fn(result.data)) : "alert" === errMsgType && $.Dialog.alert(result.msg,
                        function() {
                            fn && fn(result.data)
                        },
                        1) : fn && fn(result.data)
                ...
                Array.prototype.unique = function(method) {
                    ...
                    var flag, sameObj = method ||
                        function(a, b) {
                            var tag = !0;
                            for (var x in a) {
                                if (!b[x]) return ! 1;
                                if ("object" == typeof a[x]) tag = sameObj(a[x], b[x]);
                ...
                window._stringRender = function(template, scopeData) {
                    ...
                    return template.replace(tokenReg,
                        function(word, slash1, token, slash2) {
                            ...
                            for (var i, key, variables = token.replace(/\s/g, "").split("."), currentObject = scopeData, i = 0; key = variables[i++];) if (void 0 === (currentObject = currentObject[key]) || null === currentObject) return "";
                ...
                window.GetRandomStr = function(len) {
                    len = len || 32;
                    for (var $chars = "ABCDEFGHJKLMNOPQRSTUVWXYZabcdefhijklmnoprstuvwxyz",
                             maxPos = $chars.length,
                             pwd = "",
                             i = 0; i < len; i++) pwd += $chars.charAt(Math.floor(Math.random() * maxPos));
                    return pwd
                };
            var JsonUtil = {
                n: "\n",
                ...
                __writeObj: function(obj, level, isInArray) {
                    ...
                    for (var name in obj) {
                        ...
                        temp.push(paddingTab),
                            temp.push(name + " : ");
                        var val = obj[name];
                        if (null == val) temp.push("null");
                        else {
                            var c = val.constructor;
                            if (c == Array) {
                                temp.push(JsonUtil.n + paddingTab + "[" + JsonUtil.n);
                                for (var levelUp = level + 2,
                                         tempArrValue = [], i = 0; i < val.length; i++) tempArrValue.push(JsonUtil.__writeObj(val[i], levelUp, !0));
                ...
                m.draw = function() {
                    ...
                    j.register("pie", {
                        ...
                        function(a) {
                            ...
                            if (b = this.values(), "/" == a.delimiter) var c = b[0],
                                b = [c, h.max(0, b[1] - c)];
                            for (var d = 0,
                                     c = b.length,
                                     f = 0; d < c; d++) f += b[d];
                        ...
                        function(a) {
                            for (var b = this.values(), c = h.max.apply(h, b.concat([a.max])), d = h.min.apply(h, b.concat([a.min])), f = this.prepare(a.width, a.height), g = f.width(), f = f.height(), e = c - d, j = 0 == e ? 0 : f / e, a = a.gap, g = (g + a) / b.length, m = this.fill(), i = 0; i < b.length; i++) {
                                var n = b[i],
                                    l = f - j * (n - d),
                                    k = j * n;
                                0 == k ? (k = r, (0 >= d && 0 < c || 0 == e) && (l -= r)) : 0 > k && (l += k, k = -k),
                                    n = o("rect", {
                ...
                function(window, document, undefined) { !
                    function(factory) {
                        ...
                        function convertNotation(options, notation) {
                            for (var obj, i = 0,
                                     option = options,
                                     levels = notation.split("."); option = option[levels[i++]];) i < levels.length && (obj = option);
                        ...
                        function hideMethod(event) {
                            ...
                            } catch(e) {} else this.timers.hide = delay.call(this,
                                function() {
                        ...
                        function delegate(selector, events, method) {
                            $(document.body).delegate(selector, (events.split ? events: events.join(ns + " ")) + ns,
                                function() {
                        ...
                        function init(elem, id, opts) {
                            ...
                            if (config = $.extend(TRUE, {},
                                QTIP.defaults, opts, "object" == typeof html5 ? sanitizeOptions(html5) : NULL, sanitizeOptions(metadata5 || metadata)), posOptions = config.position, config.id = id, "boolean" == typeof config.content.text) {
                                if (attr = elem.attr(config.content.attr), config.content.attr === FALSE || !attr) return FALSE;
                                config.content.text = attr
                            }
                            if (posOptions.container.length || (posOptions.container = docBody), posOptions.target === FALSE && (posOptions.target = newTarget), config.show.target === FALSE && (config.show.target = newTarget), config.show.solo === TRUE && (config.show.solo = posOptions.container.closest("body")), config.hide.target === FALSE && (config.hide.target = newTarget), config.position.viewport === TRUE && (config.position.viewport = posOptions.container), posOptions.container = posOptions.container.eq(0), posOptions.at = new CORNER(posOptions.at, TRUE), posOptions.my = new CORNER(posOptions.my), elem.data(NAMESPACE)) if (config.overwrite) elem.qtip("destroy", !0);
                            ...
                            config.suppress && (title = elem.attr("title")) && elem.removeAttr("title").attr(oldtitle, title).attr("title", ""),
                                ...
                                elem.one("remove.qtip-" + id + " removeqtip.qtip-" + id,
                                    function() {
                                        var api; (api = $(this).data(NAMESPACE)) && api.destroy(!0)
                                    }),
                                obj
                        }
                        function camel(s) {
                        ...
                        function vendorCss(elem, prop) {
                            ...
                            for (; cur = props[i++];) if ((val = elem.css(cur)) !== undefined) return cssProps[prop] = cur,
                                val
                        }
                        ...
                        var QTIP, PROTOTYPE, CORNER, CHECKS, trackingBound, TRUE = !0,
                            ...
                            BROWSER = {
                                ie: function() {
                                    for (var v = 3,
                                             div = document.createElement("div"); (div.innerHTML = "\x3c!--[if gt IE " + ++v + "]><i></i><![endif]--\x3e") && div.getElementsByTagName("i")[0];);
                                    return v > 4 ? v: NaN
                                } (),
                        ...
                        PROTOTYPE = QTip.prototype,
                            ...
                            PROTOTYPE.render = function(show) {
                                ...
                                title && (this._createTitle(), $.isFunction(title) || deferreds.push(this._updateTitle(title, FALSE))),
                        ...
                        PROTOTYPE.set = function(option, value) {
                            ...
                            var name, rendered = this.rendered,
                                ...
                                options = this.options;
                            this.checks;
                            return "string" == typeof option ? (name = option, option = {},
                                option[name] = value) : option = $.extend({},
                                option),
                                $.each(option,
                            ...
                            PROTOTYPE._createTitle = function() {
                                ...
                                elements.titlebar && this._removeTitle(),
                                    elements.titlebar = $("<div />", {
                                        ...
                                        "aria-atomic": TRUE
                                    })).insertBefore(elements.content).delegate(".qtip-close", "mousedown keydown mouseup keyup mouseout",
                                        function(event) {
                            ...
                            PROTOTYPE.reposition = function(event, effect) {
                                ...
                                this.positioning = TRUE;
                                var pluginCalculations, offset, cache = this.cache,
                                ...
                                adjust.mouse && isScroll && mouse && (position.left -= (mouse.scrollX || 0) - win.scrollLeft(), position.top -= (mouse.scrollY || 0) - win.scrollTop());
                                    ...
                                    pluginCalculations && (targetWidth = pluginCalculations.width, targetHeight = pluginCalculations.height, offset = pluginCalculations.offset, position = pluginCalculations.position),
                                        position = this.reposition.offset(target, position, container),
                                    (BROWSER.iOS > 3.1 && BROWSER.iOS < 4.1 || BROWSER.iOS >= 4.3 && BROWSER.iOS < 4.33 || !BROWSER.iOS && "fixed" === type) && (position.left -= win.scrollLeft(), position.top -= win.scrollTop()),
                                    (!pluginCalculations || pluginCalculations && pluginCalculations.adjustable !== FALSE) && (position.left += at.x === RIGHT ? targetWidth: at.x === CENTER ? targetWidth / 2 : 0, position.top += "bottom" === at.y ? targetHeight: at.y === CENTER ? targetHeight / 2 : 0)
                                }
                                return position.left += adjust.x + (my.x === RIGHT ? -tooltipWidth: my.x === CENTER ? -tooltipWidth / 2 : 0),
                                    ...
                                    PLUGINS.viewport ? (position.adjusted = PLUGINS.viewport(this, position, posOptions, targetWidth, targetHeight, tooltipWidth, tooltipHeight), offset && position.adjusted.left && (position.left += offset.left), offset && position.adjusted.top && (position.top += offset.top)) : position.adjusted = {
                                        left: 0,
                                        top: 0
                                    },
                                    this._trigger("move", [position, viewport.elem || viewport], event) ? (delete position.adjusted, effect === FALSE || !visible || isNaN(position.left) || isNaN(position.top) || "mouse" === target || !$.isFunction(posOptions.effect) ? tooltip.css(position) : $.isFunction(posOptions.effect) && (posOptions.effect.call(tooltip, this, $.extend({},
                                        position)), tooltip.queue(function(next) {
                                        $(this).css({
                                            opacity: "",
                                            height: ""
                                        }),
                            ...
                            PROTOTYPE.reposition.offset = function(elem, pos, container) {
                                ...
                                return scrolled && (scrolled[0] !== ownerDocument[0] || quirks) && scroll(scrolled, 1),
                                    pos
                            };
                        ...
                        C.invert = function(z, center) {
                            ...
                            PROTOTYPE.toggle = function(state, event) {
                                ...
                                return (typeof state).search("boolean|number") && (state = !visible),
                                    ...
                                    this.destroyed ? this: (allow !== FALSE && state && this.focus(event), !allow || identicalState ? this: ($.attr(tooltip[0], "aria-hidden", !state), state ? (cache.origin = cloneEvent(this.mouse), $.isFunction(contentOptions.text) && this._updateContent(contentOptions.text, FALSE), $.isFunction(contentOptions.title) && this._updateTitle(contentOptions.title, FALSE), !trackingBound && "mouse" === posOptions.target && posOptions.adjust.mouse && ($(document).bind("mousemove." + NAMESPACE, this._storeMouse), trackingBound = TRUE), width || tooltip.css("width", tooltip.outerWidth(FALSE)), this.reposition(event, arguments[2]), width || tooltip.css("width", ""), opts.solo && ("string" == typeof opts.solo ? $(opts.solo) : $(SELECTOR, opts.solo)).not(tooltip).not(opts.target).qtip("hide", $.Event("tooltipsolo"))) : (clearTimeout(this.timers.show), delete cache.origin, trackingBound && !$(SELECTOR + '[tracking="true"]:visible', opts.solo).not(tooltip).length && ($(document).unbind("mousemove." + NAMESPACE), trackingBound = FALSE), this.blur(event)), after = $.proxy(function() {
                                        ...
                                        this), opts.effect === FALSE || animate === FALSE ? (tooltip[type](), after()) : $.isFunction(opts.effect) ? (tooltip.stop(1, 1), opts.effect.call(tooltip, this), tooltip.queue("fx",
                                        function(n) {
                                            after(),
                                                n()
                            ...
                            PROTOTYPE.focus = function(event) {
                                ...
                                }), qtips.filter("." + CLASS_FOCUS).qtip("blur", event)), tooltip.addClass(CLASS_FOCUS)[0].style.zIndex = newIndex),
                                    this
                            },
                        ...
                        $(function() {
                            delegate(SELECTOR, ["mouseenter", "mouseleave"],
                                function(event) {
                                    var state = "mouseenter" === event.type,
                                        ...
                                        options = this.options;
                                    state ? (this.focus(event), tooltip.hasClass(CLASS_FIXED) && !tooltip.hasClass(CLASS_DISABLED) && clearTimeout(this.timers.hide)) : "mouse" === options.position.target && options.hide.event && options.show.target && !target.closest(options.show.target[0]).length && this.hide(event),
                            ...
                            PROTOTYPE._trigger = function(type, args, event) {
                                ...
                                return callback.originalEvent = event && $.extend({},
                                    event) || this.cache.event || NULL,
                            ...
                            PROTOTYPE._bindEvents = function(showEvents, hideEvents, showTarget, hideTarget, showMethod, hideMethod) {
                                if (hideTarget.add(showTarget).length === hideTarget.length) {
                                    var toggleEvents = [];
                                    hideEvents = $.map(hideEvents,
                                        function(type) {
                                            var showIndex = $.inArray(type, showEvents);
                                            return showIndex > -1 ? void toggleEvents.push(showEvents.splice(showIndex, 1)[0]) : type
                                        }),
                                    toggleEvents.length && this._bind(showTarget, toggleEvents,
                                        function(event) { ( !! this.rendered && this.tooltip[0].offsetWidth > 0 ? hideMethod: showMethod).call(this, event)
                                        })
                                }
                            ...
                            PROTOTYPE._assignInitialEvents = function(event) {
                                ...
                                /mouse(over|enter)/i.test(options.show.event) && !/mouse(out|leave)/i.test(options.hide.event) && hideEvents.push("mouseleave"),
                                    this._bind(showTarget, "mousemove",
                                        function(event) {
                                            this._storeMouse(event),
                                                this.cache.onTarget = TRUE
                                        }),
                                    this._bindEvents(showEvents, hideEvents, showTarget, hideTarget, hoverIntent,
                                        function() {
                                            clearTimeout(this.timers.show)
                                        }),
                            ...
                            PROTOTYPE._assignEvents = function() {
                                ...
                                /mouse(out|leave)/i.test(options.hide.event) && "window" === options.hide.leave && this._bind(documentTarget, ["mouseout", "blur"],
                                    function(event) { / select | option / .test(event.target.nodeName) || event.relatedTarget || this.hide(event)
                                    }),
                                    options.hide.fixed ? hideTarget = hideTarget.add(tooltip.addClass(CLASS_FIXED)) : /mouse(over|enter)/i.test(options.show.event) && this._bind(hideTarget, "mouseleave",
                                        function() {
                                            clearTimeout(this.timers.show)
                                        }),
                                ("" + options.hide.event).indexOf("unfocus") > -1 && this._bind(containerTarget.closest("html"), ["mousedown", "touchstart"],
                                    function(event) {
                                ...
                                "number" == typeof options.hide.inactive && (this._bind(showTarget, "qtip-" + this.id + "-inactive", inactiveMethod), this._bind(hideTarget.add(tooltip), QTIP.inactiveEvents, inactiveMethod, "-inactive")),
                                    this._bindEvents(showEvents, hideEvents, showTarget, hideTarget, showMethod, hideMethod),
                                    this._bind(showTarget.add(tooltip), "mousemove",
                                        function(event) {
                                            if ("number" == typeof options.hide.distance) {
                                                var origin = this.cache.origin || {},
                                                    limit = this.options.hide.distance,
                                                    abs = Math.abs; (abs(event.pageX - origin.pageX) >= limit || abs(event.pageY - origin.pageY) >= limit) && this.hide(event)
                                            }
                                            this._storeMouse(event)
                                        }),
                                "mouse" === posOptions.target && posOptions.adjust.mouse && (options.hide.event && this._bind(showTarget, ["mouseenter", "mouseleave"],
                                    function(event) {
                                        this.cache.onTarget = "mouseenter" === event.type
                                    }), this._bind(documentTarget, "mousemove",
                                    function(event) {
                            ...
                            PROTOTYPE._unassignEvents = function() {
                                ...
                                this._unbind($([]).pushStack($.grep(targets,
                                    function(i) {
                            ...
                            QTIP = $.fn.qtip = function(options, notation, newValue) {
                                ...
                                return ! arguments.length && opts || "api" === command ? opts: "string" == typeof options ? (this.each(function() {
                                    ...
                                    if (event && event.timeStamp && (api.cache.event = event), !notation || "option" !== command && "options" !== command) api[command] && api[command].apply(api, args);
                                        ...
                                        if (newValue === undefined && !$.isPlainObject(notation)) return returned = api.get(notation),
                                            FALSE;
                                        api.set(notation, newValue)
                                    }
                                }), returned !== NULL ? returned: this) : "object" != typeof options && arguments.length ? void 0 : (opts = sanitizeOptions($.extend(TRUE, {},
                                    options)), this.each(function(i) {
                                    var api, id;
                            ...
                            $.each({
                                    ...
                                    clone: function(keepData) {
                                        ...
                                        return keepData || elems.filter("[" + oldtitle + "]").attr("title",
                                            function() {
                        ...
                        $.extend(Tip.prototype, {
                            init: function(qtip) {
                                ...
                                tip = this.element = qtip.elements.tip = $("<div />", {
                                    ...
                                    HASCANVAS ? (context = $("<canvas />").appendTo(this.element)[0].getContext("2d"), context.lineJoin = "miter", context.miterLimit = 1e5, context.save()) : (context = createVML("shape", 'coordorigin="0,0"', "position:absolute;"), this.element.html(context + context), qtip._bind($("*", tip).add(tip), ["click", "mousedown"],
                                        function(event) {
                            ...
                            _parseCorner: function(corner) {
                                ...
                                return corner === FALSE || my === FALSE ? corner = FALSE: corner === TRUE ? corner = new CORNER(my.string()) : corner.string || (corner = new CORNER(corner), corner.fixed = TRUE),
                                    corner
                            },
                            ...
                            create: function() {
                                ...
                                return (this.enabled = !!this.corner && "c" !== this.corner.abbrev()) && (this.qtip.cache.corner = c.clone(), this.update()),
                            ...
                            update: function(corner, position) {
                                ...
                                corner || (corner = this.qtip.cache.corner || this.corner),
                                    mimic === FALSE ? mimic = corner: (mimic = new CORNER(mimic), mimic.precedance = corner.precedance, "inherit" === mimic.x ? mimic.x = corner.x: "inherit" === mimic.y ? mimic.y = corner.y: mimic.x === mimic.y && (mimic[corner.precedance] = corner[corner.precedance])),
                                    precedance = mimic.precedance,
                                    corner.precedance === X ? this._swapDimensions() : this._resetDimensions(),
                                    color = this.color = this._parseColours(corner),
                                    "transparent" !== color[1] ? (border = this.border = this._parseWidth(corner, corner[corner.precedance]), options.border && border < 1 && !INVALID.test(color[1]) && (color[0] = color[1]), this.border = border = options.border !== TRUE ? options.border: border) : this.border = border = 0,
                            ...
                            reposition: function(event, api, pos, viewport) {
                                ...
                                if (this.enabled) {
                                    var offset, props, cache = api.cache,
                                        ...
                                        css = {};
                                    this.corner.fixed !== TRUE && (shiftflip(horizontal, X, Y, LEFT, RIGHT), shiftflip(vertical, Y, X, TOP, "bottom"), newCorner.string() === cache.corner.string() || cache.cornerTop === adjust.top && cache.cornerLeft === adjust.left || this.update(newCorner, FALSE)),
                        ...
                        OVERLAY = function() {
                            ...
                            $.extend(self, {
                                ...
                                toggle: function(api, state, duration) {
                                    ...
                                    state && elem.appendTo(document.body),
                                        elem.is(":animated") && visible === state && prevState !== FALSE || !state && visibleModals.length ? self: (elem.stop(TRUE, FALSE), $.isFunction(effect) ? effect.call(elem, state) : effect === FALSE ? elem[type]() : elem.fadeTo(parseInt(duration, 10) || 90, state ? 1 : 0,
                                            function() {
                                                state || elem.hide()
                            ...
                            $.extend(Modal.prototype, {
                                init: function(qtip) {
                                    ...
                                    qtip.elements.overlay = OVERLAY.elem,
                                        ...
                                        qtip._bind(tooltip, ["tooltipshow", "tooltiphide"],
                                            ...
                                            this._ns, this),
                                        qtip._bind(tooltip, "tooltipfocus",
                                            function(event, api) {
                                            ...
                                            this._ns, this),
                                        qtip._bind(tooltip, "tooltiphide",
                                            function(event) {
                            ...
                            PLUGINS.polys = {
                                polygon: function(baseCoords, corner) {
                                    var next, newWidth, newHeight, result = {
                                        ...
                                        realX = 0,
                                        realY = 0;
                                    for (i = baseCoords.length; i--;) next = [parseInt(baseCoords[--i], 10), parseInt(baseCoords[i + 1], 10)],
                                    ...
                                    if (newWidth = result.width = Math.abs(result.position.right - result.position.left), newHeight = result.height = Math.abs(result.position.bottom - result.position.top), "c" === corner.abbrev()) result.position = {
                                        ...
                                        for (; newWidth > 0 && newHeight > 0 && compareX > 0 && compareY > 0;) for (newWidth = Math.floor(newWidth / 2), newHeight = Math.floor(newHeight / 2), corner.x === LEFT ? compareX = newWidth: corner.x === RIGHT ? compareX = result.width - newWidth: compareX += Math.floor(newWidth / 2), corner.y === TOP ? compareY = newHeight: "bottom" === corner.y ? compareY = result.height - newHeight: compareY += Math.floor(newHeight / 2), i = coords.length; i--&&!(coords.length < 2);) realX = coords[i][0] - result.position.left,
                            ...
                            PLUGINS.svg = function(api, svg, corner) {
                                ...
                                switch (strokeWidth2 && (xScale += strokeWidth2 / rootWidth, yScale += strokeWidth2 / rootHeight), elem.nodeName) {
                                    ...
                                    case "polyline":
                                        for (points = elem.points || [{
                                            ...
                                            }], result = [], i = -1, len = points.numberOfItems || points.length; ++i < len;) next = points.getItem ? points.getItem(i) : points[i],
                                ...
                                return position = result.position,
                                    root = root[0],
                                complex && (root.createSVGPoint && (mtx = elem.getScreenCTM(), points = root.createSVGPoint(), points.x = position.left, points.y = position.top, transformed = points.matrixTransform(mtx), position.left = transformed.x, position.top = transformed.y), root.viewBox && (viewBox = root.viewBox.baseVal) && viewBox.width && viewBox.height && (xScale *= rootWidth / viewBox.width, yScale *= rootHeight / viewBox.height)),
                            ...
                            PLUGINS.imagemap = function(api, area, corner, adjustMethod) {
                                ...
                                var imageOffset, coords, i, result, len, shape = area.attr("shape").toLowerCase().replace("poly", "polygon"),
                                    image = $('img[usemap="#' + area.parent("map").attr("name") + '"]'),
                                    coordsString = $.trim(area.attr("coords")),
                                    coordsArray = coordsString.replace(/,$/, "").split(",");
                                if (!image.length) return FALSE;
                                if ("polygon" === shape) result = PLUGINS.polys.polygon(coordsArray, corner);
                                else {
                        ...
                        $.extend(Ie6.prototype, {
                            ...
                            init: function(qtip) {
                                ...
                                qtip.elements.overlay && qtip.elements.overlay.addClass("qtipmodal-ie6fix") && (qtip._bind(window, ["scroll", "resize"], this._scroll, this._ns, this), qtip._bind(tooltip, ["tooltipshow"], this._scroll, this._ns, this)),
                                    this.redraw()
                            },
                            adjustBGIFrame: function() {
                                ...
                                plugin && tip && (tipAdjust = "x" === plugin.corner.precedance ? [WIDTH, LEFT] : ["height", TOP], offset[tipAdjust[1]] -= tip[tipAdjust[0]]()),
                                    this.bgiframe.css(offset).css(dimensions)
                            },
                            redraw: function() {
                                if (this.qtip.rendered < 1 || this.drawing) return this;
                                var perc, width, max, min, tooltip = this.qtip.tooltip,
                                    style = this.qtip.options.style,
                                    container = this.qtip.options.position.container;
                                return this.qtip.drawing = 1,
                                style.height && tooltip.css("height", style.height),
                                    style.width ? tooltip.css(WIDTH, style.width) : (tooltip.css(WIDTH, "").appendTo(this.redrawContainer), width = tooltip.width(), width % 2 < 1 && (width += 1), max = tooltip.css("maxWidth") || "", min = tooltip.css("minWidth") || "", perc = (max + min).indexOf("%") > -1 ? container.width() / 100 : 0, max = (max.indexOf("%") > -1 ? perc: 1) * parseInt(max, 10) || width, min = (min.indexOf("%") > -1 ? perc: 1) * parseInt(min, 10) || 0, width = max + min ? Math.min(Math.max(width, min), max) : width, tooltip.css(WIDTH, Math.round(width)).appendTo(container)),
                                    this.drawing = 0,
                                    this
                            },
                            destroy: function() {
        ...
        function(module, exports) {
            ...
            dialogHelper__.initDialogs = function() {
                jQuery.extend({
                    Dialog: {
                        alert: function(content, fn, icon) {
                            ...
                            icon && (conf.icon = icon),
                                conf.title = "提示信息",
                                window.layer.alert(content, conf,
                                    function(index) {
                                        fn && jQuery.isFunction(fn) && fn(),
                                        window && window.layer && window.layer.close(index),
                                            layer.close(index)
                                    })
                        },
                        ...
                        open: function(conf) { ! 0 === conf.btn && (conf.btn = ["确定", "取消"], conf.ok || alert("确定btn 没有回调？"));
                            var iframeId, height = conf.height,
                                width = conf.width,
                                title = conf.title,
                                url = conf.url,
                            ...
                            if (!conf.type) return jQuery.Dialog.msg("请设置访问地址!或者指定对话框类型"),
                                !1;
                            height || (height = jQuery(openWindow).height(), width = jQuery(openWindow).width()),
                            height || (height = 500),
                            width || (width = 600),
                                delete conf.url,
                                delete conf.height,
                    ...
                    Toast: {
                        warning: function(content, title) {
                            if (top.toastr) return void top.toastr.warning(content, title);
                            toastr.warning(content, title)
                        },
                        success: function(content, title) {
                            if (top.toastr) return void top.toastr.success(content, title);
                            toastr.success(content, title)
                        },
                        error: function(content, title) {
                            if (title || (title = "错误提示！"), top.toastr) return void top.toastr.error(content, title);
                ...
                dialogHelper__.init = function() {
                    jQuery("body").delegate("[openDialog]", "click",
                        function() {
                            var me = jQuery(this),
                ...
                dialogHelper__.initCustDialogs = function() {
                    window.CustUtil = {
                        openCustDialog: function(key, param, callBack, initData, dialogSetting, closeDialog) {
                            jQuery.isFunction(param) && (dialogSetting = initData, initData = callBack, callBack = param, param = {}),
                            ...
                            jQuery.post(__ctx + "/form/formCustDialog/getObject?key=" + key, {},
                                function(result) {
                        ...
                        doCustQuery: function(key, param, callBack, dialogSetting) {
                            jQuery.isFunction(param) && (dialogSetting = callBack, callBack = param, param = {}),
                            param || (param = {}),
                            callBack || (callBack = function(data) {
                                ...
                                jQuery.post(__ctx + "/form/formCustDialog/getObject?key=" + key, {},
                                    function(result) {
                                        ...
                                        dialogConf.page && (null == param.offset && (param.offset = 0), null == param.limit && (param.limit = dialogConf.pageSize)),
                                            window.CustUtil.handleParam(dialogConf, param),
                                            jQuery.post(__ctx + "/form/formCustDialog/listData_" + key, param,
                                                function(rlt) {
                                                    var datas = [];
                                                    jQuery.each(rlt.rows,
                                                        function(index, row) {
                                                            var data = {};
                                                            jQuery.each(dialogConf.returnFields,
                                                                function(i, field) {
                        ...
                        handleParam: function(dialog, param) {
                            param && jQuery.each(dialog.conditionFields,
                ...
                dialogHelper__.getProjectUrl = function(url) {
                    if (url && -1 == url.indexOf("http://") && "/" === url.substring(0, 1)) {
                        var pathname = window.document.location.pathname,
                            projectPath = pathname.substring(0, pathname.substr(1).indexOf("/") + 1);
                        return "" === projectPath || -1 != "/bus,/bpm,/sys,/org,/form,/flow-editor".indexOf(projectPath) ? url: url.startWith(projectPath) ? url: projectPath + url
                    }
                    return url
                }
        },
        function(module, exports) {},
        function(module, exports, __webpack_require__) { (function(global) {
            module.exports = global.toastr = __webpack_require__(27)
        }).call(exports, __webpack_require__(1))
        },
        function(module, exports, __webpack_require__) {
            var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__; !
                ...
                function(a, b) {
                    ...
                    h.anim = ["layui-anim", "layui-anim-01", "layui-anim-02", "layui-anim-03", "layui-anim-04", "layui-anim-05", "layui-anim-06"],
                        ...
                        g.pt.callback = function() {
                            function a() { ! 1 === (g.cancel && g.cancel(b.index)) || f.close(b.index)
                            }
                            var b = this,
                                d = b.layero,
                                g = b.config;
            ...
            var __WEBPACK_AMD_DEFINE_RESULT__; !
                function() {
                    ...
                    var isLayui = window.layui && layui.define,
                        ready = {
                            getPath: function() {
                                var jsPath = document.currentScript ? document.currentScript.src: function() {
                                    for (var src, js = document.scripts,
                                             last = js.length - 1,
                                             i = last; i > 0; i--) if ("interactive" === js[i].readyState) {
                                        src = js[i].src;
                                        break
                                    }
                        ...
                        Class = function(options) {
                            ...
                            that.index = ++laydate.index,
                                that.config = lay.extend({},
                                    that.config, laydate.config, options),
                        ...
                        LAY = function(selector) {
                            for (var index = 0,
                                     nativeDOM = "object" == typeof selector ? [selector] : (this.selector = selector, document.querySelectorAll(selector || null)); index < nativeDOM.length; index++) this.push(nativeDOM[index])
                        };
                    LAY.prototype = [],
                        ...
                        LAY.prototype.on = function(eventName, fn) {
                            return this.each(function(index, item) {
                                item.attachEvent ? item.attachEvent("on" + eventName,
                                    function(e) {
                        ...
                        Class.prototype.init = function() {
                            ...
                            options.elem[0] && (!0 === options.range && (options.range = "-"), options.format === format.date && (options.format = format[options.type]), that.format = options.format.match(new RegExp(dateType + "|.", "g")) || [], that.EXP_IF = "", that.EXP_SPLIT = "", lay.each(that.format,
                                function(i, item) {
                                    var EXP = new RegExp(dateType).test(item) ? "\\d{" +
                                        function() {
                                ...
                                }), that.EXP_IF = new RegExp("^" + (options.range ? that.EXP_IF + "\\s\\" + options.range + "\\s" + that.EXP_IF: that.EXP_IF) + "$"), that.EXP_SPLIT = new RegExp("^" + that.EXP_SPLIT + "$", ""), that.isInput(options.elem[0]) || "focus" === options.trigger && (options.trigger = "click"), options.elem.attr("lay-key") || (options.elem.attr("lay-key", that.index), options.eventElem.attr("lay-key", that.index)), options.mark = lay.extend({},
                                options.calendar && "cn" === options.lang ? {
                                    "0-1-1": "元旦",
                                    "0-2-14": "情人",
                                    "0-3-8": "妇女",
                                    "0-3-12": "植树",
                                ...
                                function(i, item) {
                                    ...
                                    } else ymd = (options[item].match(/\d+-\d+-\d+/) || [""])[0].split("-"),
                        ...
                        Class.prototype.render = function() {
                            ...
                            if (options.zIndex && (elem.style.zIndex = options.zIndex), lay.each(new Array(2),
                                function(i) {
                                    ...
                                    var divHeader = lay.elem("div", {
                                        ...
                                        theadTr = lay.elem("tr");
                                    lay.each(headerChild,
                                        function(i, item) {
                                            divHeader.appendChild(item)
                                        }),
                                        thead.appendChild(theadTr),
                                        lay.each(new Array(6),
                                            function(i) {
                                                var tr = table.insertRow(0);
                                                lay.each(new Array(7),
                                                    function(j) {
                                                        if (0 === i) {
                                                            var th = lay.elem("th");
                                ...
                                "styleSheet" in style ? (style.setAttribute("type", "text/css"), style.styleSheet.cssText = styleText) : style.innerHTML = styleText,
                            ...
                            "function" == typeof options.ready && options.ready(lay.extend({},
                                options.dateTime, {
                        ...
                        Class.prototype.remove = function(prev) {
                            var that = this,
                                elem = (that.config, lay("#" + (prev || that.elemID)));
                        ...
                        Class.prototype.position = function() {
                            ...
                            top + elemHeight + 5 > winArea() && (top = rect.top > elemHeight ? rect.top - elemHeight: winArea() - elemHeight, top -= 10),
                        ...
                        Class.prototype.checkDate = function(fn) {
                            var thisMaxDate, error, that = this,
                                options = (new Date, that.config),
                                dateTime = options.dateTime = options.dateTime || that.systemDate(),
                                elem = that.bindElem || options.elem[0],
                                value = (that.isInput(elem), that.isInput(elem) ? elem.value: "static" === options.position ? "": elem.innerHTML),
                                checkValid = function(dateTime) {
                                    dateTime.year > LIMIT_YEAR[1] && (dateTime.year = LIMIT_YEAR[1], error = !0),
                                    dateTime.month > 11 && (dateTime.month = 11, error = !0),
                                    dateTime.hours > 23 && (dateTime.hours = 0, error = !0),
                                    dateTime.minutes > 59 && (dateTime.minutes = 0, dateTime.hours++, error = !0),
                                    dateTime.seconds > 59 && (dateTime.seconds = 0, dateTime.minutes++, error = !0),
                                        thisMaxDate = laydate.getEndDate(dateTime.month + 1, dateTime.year),
                                    dateTime.date > thisMaxDate && (dateTime.date = thisMaxDate, error = !0)
                                },
                                initDate = function(dateTime, value, index) {
                                    ...
                                    options.range && (that[startEnd[index]] = that[startEnd[index]] || {}),
                                        lay.each(that.format,
                                            function(i, item) {
                                                var thisv = parseFloat(value[i]);
                                                value[i].length < item.length && (error = !0),
                                                    /yyyy|y/.test(item) ? (thisv < LIMIT_YEAR[0] && (thisv = LIMIT_YEAR[0], error = !0), dateTime.year = thisv) : /MM|M/.test(item) ? (thisv < 1 && (thisv = 1, error = !0), dateTime.month = thisv - 1) : /dd|d/.test(item) ? (thisv < 1 && (thisv = 1, error = !0), dateTime.date = thisv) : /HH|H/.test(item) ? (thisv < 1 && (thisv = 0, error = !0), dateTime.hours = thisv, options.range && (that[startEnd[index]].hours = thisv)) : /mm|m/.test(item) ? (thisv < 1 && (thisv = 0, error = !0), dateTime.minutes = thisv, options.range && (that[startEnd[index]].minutes = thisv)) : /ss|s/.test(item) && (thisv < 1 && (thisv = 0, error = !0), dateTime.seconds = thisv, options.range && (that[startEnd[index]].seconds = thisv))
                                            }),
                                        checkValid(dateTime)
                                };
                            return "limit" === fn ? (checkValid(dateTime), that) : (value = value || options.value, "string" == typeof value && (value = value.replace(/\s+/g, " ").replace(/^\s|\s$/g, "")), that.startState && !that.endState && (delete that.startState, that.endState = !0), "string" == typeof value && value ? that.EXP_IF.test(value) ? options.range ? (value = value.split(" " + options.range + " "), that.startDate = that.startDate || that.systemDate(), that.endDate = that.endDate || that.systemDate(), options.dateTime = lay.extend({},
                                that.startDate), lay.each([that.startDate, that.endDate],
                                function(i, item) {
                        ...
                        Class.prototype.calendar = function(value) {
                            var startWeek, prevMaxDate, thisMaxDate, that = this,
                                options = that.config,
                                dateTime = value || options.dateTime,
                                thisDate = new Date,
                                lang = that.lang(),
                                isAlone = "date" !== options.type && "datetime" !== options.type,
                                index = value ? 1 : 0,
                                tds = lay(that.table[index]).find("td"),
                                elemYM = lay(that.elemHeader[index][2]).find("span");
                            if (dateTime.year < LIMIT_YEAR[0] && (dateTime.year = LIMIT_YEAR[0], that.hint("最低只能支持到公元" + LIMIT_YEAR[0] + "年")), dateTime.year > LIMIT_YEAR[1] && (dateTime.year = LIMIT_YEAR[1], that.hint("最高只能支持到公元" + LIMIT_YEAR[1] + "年")), that.firstDate || (that.firstDate = lay.extend({},
                                dateTime)), thisDate.setFullYear(dateTime.year, dateTime.month, 1), startWeek = thisDate.getDay(), prevMaxDate = laydate.getEndDate(dateTime.month || 12, dateTime.year), thisMaxDate = laydate.getEndDate(dateTime.month + 1, dateTime.year), lay.each(tds,
                                function(index, item) {
                                    var YMD = [dateTime.year, dateTime.month],
                                        st = 0;
                                    item = lay(item),
                                        item.removeAttr("class"),
                                        index < startWeek ? (st = prevMaxDate - startWeek + index, item.addClass("laydate-day-prev"), YMD = that.getAsYM(dateTime.year, dateTime.month, "sub")) : index >= startWeek && index < thisMaxDate + startWeek ? (st = index - startWeek, options.range || st + 1 === dateTime.date && item.addClass(THIS)) : (st = index - thisMaxDate - startWeek, item.addClass("laydate-day-next"), YMD = that.getAsYM(dateTime.year, dateTime.month)),
                                        YMD[1]++,
                                        YMD[2] = st + 1,
                            ...
                            value && (that.listYM = [[that.startDate.year, that.startDate.month + 1], [that.endDate.year, that.endDate.month + 1]], that.list(options.type, 0).list(options.type, 1), "time" === options.type ? that.setBtnStatus("时间", lay.extend({},
                                that.systemDate(), that.startTime), lay.extend({},
                                that.systemDate(), that.endTime)) : that.setBtnStatus(!0))), options.range || (that.listYM = [[dateTime.year, dateTime.month + 1]], that.list(options.type, 0))), options.range && !value) {
                                var EYM = that.getAsYM(dateTime.year, dateTime.month);
                                that.calendar(lay.extend({},
                                    dateTime, {
                                        year: EYM[0],
                                        month: EYM[1]
                                    }))
                        ...
                        Class.prototype.list = function(type, index) {
                                    ...
                                    lay.each(new Array(15),
                                        function(i) {
                                            ...
                                            yearNum == listYM[0] && lay(li).addClass(THIS),
                                                ...
                                                ul.appendChild(li),
                                                yearNum < that.firstDate.year ? (ymd.month = options.min.month, ymd.date = options.min.date) : yearNum >= that.firstDate.year && (ymd.month = options.max.month, ymd.date = options.max.date),
                                                that.limit(lay(li), ymd, index),
                                                yearNum++
                                        }),
                                    lay(elemYM[isCN ? 0 : 1]).attr("lay-ym", yearNum - 8 + "-" + listYM[1]).html(startY + text + " - " + (yearNum - 1 + text))
                            } else if ("month" === type) lay.each(new Array(12),
                                function(i) {
                                    var li = lay.elem("li", {
                                            "lay-ym": i
                                        }),
                            ...
                            if (haveList && elemCont.removeChild(haveList), elemCont.appendChild(ul), "year" === type || "month" === type) lay(that.elemMain[index]).addClass("laydate-ym-show"),
                                lay(ul).find("li").on("click",
                                    function() {
                                        var ym = 0 | lay(this).attr("lay-ym");
                                        if (!lay(this).hasClass(DISABLED)) {
                                            if (0 === index) dateTime[type] = ym,
                                            isAlone && (that.startDate[type] = ym),
                                                that.limit(lay(that.footer).find(ELEM_CONFIRM), null, 0);
                                            else if (isAlone) that.endDate[type] = ym;
                                            else {
                                            ...
                                            "year" === options.type || "month" === options.type ? (lay(ul).find("." + THIS).removeClass(THIS), lay(this).addClass(THIS), "month" === options.type && "year" === type && (that.listYM[index][0] = ym, isAlone && (that[["startDate", "endDate"][index]].year = ym), that.list("month", index))) : (that.checkDate("limit").calendar(), that.closeList()),
                                                that.setBtnStatus(),
                                    ...
                                    scroll = function() {
                                        lay(ul).find("ol").each(function(i) {
                                            ...
                                            ol.scrollTop <= 0 && li.each(function(ii, item) {
                                                if (!lay(this).hasClass(DISABLED)) return ol.scrollTop = 30 * (ii - 2),
                                                    !0
                                            })
                                        })
                                    },
                        ...
                        Class.prototype.parse = function(state, date) {
                            var that = this,
                                options = that.config,
                                dateTime = date || (state ? lay.extend({},
                                    that.endDate, that.endTime) : options.range ? lay.extend({},
                                    that.startDate, that.startTime) : options.dateTime),
                                format = that.format.concat();
                            return lay.each(format,
                                function(i, item) { / yyyy | y / .test(item) ? format[i] = lay.digit(dateTime.year, item.length) : /MM|M/.test(item) ? format[i] = lay.digit(dateTime.month + 1, item.length) : /dd|d/.test(item) ? format[i] = lay.digit(dateTime.date, item.length) : /HH|H/.test(item) ? format[i] = lay.digit(dateTime.hours, item.length) : /mm|m/.test(item) ? format[i] = lay.digit(dateTime.minutes, item.length) : /ss|s/.test(item) && (format[i] = lay.digit(dateTime.seconds, item.length))
                                }),
                        ...
                        Class.prototype.stampRange = function() {
                            var startTime, endTime, that = this,
                                options = that.config,
                        ...
                        Class.prototype.choose = function(td) {
                            var that = this,
                                ...
                                setDateTime = function(one) {
                                    ...
                                    options.range && (that.startDate ? lay.extend(that.startDate, YMD) : that.startDate = lay.extend({},
                                        YMD, that.startTime), that.startYMD = YMD)
                                };
                            if (YMD = {
                                year: 0 | YMD[0],
                                month: (0 | YMD[1]) - 1,
                                ...
                                if (lay.each(["startTime", "endTime"],
                                    ...
                                    if (td.addClass(THIS), that.endDate ? lay.extend(that.endDate, YMD) : that.endDate = lay.extend({},
                                        YMD, that.endTime), that.newDate(YMD).getTime() < that.newDate(that.startYMD).getTime()) {
                                        var startDate = lay.extend({},
                                            that.endDate, {
                        ...
                        Class.prototype.change = function(index) {
                            var that = this,
                                ...
                                addSubYeay = function(type) {
                                    ...
                                    return isYear && (listYM[0] = type ? listYM[0] - 15 : listYM[0] + 15, that.list("year", index)),
                                    isMonth && (type ? listYM[0]--:listYM[0]++, that.list("month", index)),
                                    (isYear || isMonth) && (lay.extend(dateTime, {
                                        year: listYM[0]
                                    }), isAlone && (that[startEnd].year = listYM[0]), options.range || that.done(null, "change"), that.setBtnStatus(), options.range || that.limit(lay(that.footer).find(ELEM_CONFIRM), {
                                        year: listYM[0]
                                    })),
                                    isYear || isMonth
                                };
                        ...
                        Class.prototype.changeEvent = function() {
                            var that = this;
                            that.config;
                            lay(that.elem).on("click",
                                function(e) {
                                    lay.stope(e)
                                }),
                                lay.each(that.elemHeader,
                                    function(i, header) {
                                        lay(header[0]).on("click",
                                            function(e) {
                                                that.change(i).prevYear()
                                            }),
                                            lay(header[1]).on("click",
                                                function(e) {
                                                    that.change(i).prevMonth()
                                                }),
                                            lay(header[2]).find("span").on("click",
                                                function(e) {
                                                    var othis = lay(this),
                                            ...
                                            lay(header[3]).on("click",
                                                function(e) {
                                                    that.change(i).nextMonth()
                                                }),
                                            lay(header[4]).on("click",
                                                function(e) {
                                ...
                                lay.each(that.table,
                                    function(i, table) {
                                        lay(table).find("td").on("click",
                                            function() {
                                                that.choose(lay(this))
                                            })
                                    }),
                                lay(that.footer).find("span").on("click",
                                    function() {
                        ...
                        Class.prototype.events = function() {
                            var that = this,
                                ...
                                showEvent = function(elem, bind) {
                                    elem.on(options.trigger,
                                        function() {
                                            bind && (that.bindElem = this),
                                                that.render()
                                        })
                                };
                            options.elem[0] && !options.elem[0].eventHandler && (showEvent(options.elem, "bind"), showEvent(options.eventElem), lay(document).on("click",
                                function(e) {
        ...
        function(module, exports) { !
            function($) {
                var settings = {},
                    ...
                    _initNode = function(setting, level, n, parentNode, isFirstNode, isLastNode, openFlag) {
                        if (n) {
                            ...
                            n.level = level,
                                ...
                                n[childKey] && n[childKey].length > 0 ? (n.isParent = !0, n.zAsync = !0) : (n.isParent = "string" == typeof n.isParent ? tools.eqs(n.isParent, "true") : !!n.isParent, n.open = !(!n.isParent || setting.async.enable) && n.open, n.zAsync = !n.isParent),
                    ...
                    data = {
                        ...
                        addNodesData: function(setting, parentNode, nodes) {
                            ...
                            parentNode[childKey].length > 0 && (parentNode[childKey][parentNode[childKey].length - 1].isLastNode = !1, view.setNodeLineIcos(setting, parentNode[childKey][parentNode[childKey].length - 1])),
                        ...
                        getAfterA: function(setting, node, array) {
                            for (var i = 0,
                                     j = _init.afterA.length; i < j; i++) _init.afterA[i].apply(this, arguments)
                        },
                        getBeforeA: function(setting, node, array) {
                            for (var i = 0,
                                     j = _init.beforeA.length; i < j; i++) _init.beforeA[i].apply(this, arguments)
                        },
                        getInnerAfterA: function(setting, node, array) {
                            for (var i = 0,
                                     j = _init.innerAfterA.length; i < j; i++) _init.innerAfterA[i].apply(this, arguments)
                        },
                        getInnerBeforeA: function(setting, node, array) {
                            for (var i = 0,
                                     j = _init.innerBeforeA.length; i < j; i++) _init.innerBeforeA[i].apply(this, arguments)
                        },
                        ...
                        getNextNode: function(setting, node) {
                            if (!node) return null;
                            for (var childKey = setting.data.key.children,
                                     p = node.parentTId ? node.getParentNode() : data.getRoot(setting), i = 0, l = p[childKey].length - 1; i <= l; i++) if (p[childKey][i] === node) return i == l ? null: p[childKey][i + 1];
                            return null
                        },
                        ...
                        getNodesByParam: function(setting, nodes, key, value) {
                            if (!nodes || !key) return [];
                            for (var childKey = setting.data.key.children,
                                     result = [], i = 0, l = nodes.length; i < l; i++) nodes[i][key] == value && result.push(nodes[i]),
                        ...
                        getNodesByParamFuzzy: function(setting, nodes, key, value) {
                            ...
                            for (var i = 0,
                                     l = nodes.length; i < l; i++)"string" == typeof nodes[i][key] && nodes[i][key].toLowerCase().indexOf(value) > -1 && result.push(nodes[i]),
                        ...
                        getNodesByFilter: function(setting, nodes, filter, isSingle, invokeParam) {
                            ...
                            for (var childKey = setting.data.key.children,
                                     result = isSingle ? null: [], i = 0, l = nodes.length; i < l; i++) {
                        ...
                        getPreNode: function(setting, node) {
                            if (!node) return null;
                            for (var childKey = setting.data.key.children,
                                     p = node.parentTId ? node.getParentNode() : data.getRoot(setting), i = 0, l = p[childKey].length; i < l; i++) if (p[childKey][i] === node) return 0 == i ? null: p[childKey][i - 1];
                            return null
                        },
                        ...
                        initCache: function(setting) {
                            for (var i = 0,
                                     j = _init.caches.length; i < j; i++) _init.caches[i].apply(this, arguments)
                        },
                        initNode: function(setting, level, node, parentNode, preNode, nextNode) {
                            for (var i = 0,
                                     j = _init.nodes.length; i < j; i++) _init.nodes[i].apply(this, arguments)
                        },
                        initRoot: function(setting) {
                            for (var i = 0,
                                     j = _init.roots.length; i < j; i++) _init.roots[i].apply(this, arguments)
                        },
                        ...
                        removeNodeCache: function(setting, node) {
                            var childKey = setting.data.key.children;
                            if (node[childKey]) for (var i = 0,
                                                         l = node[childKey].length; i < l; i++) arguments.callee(setting, node[childKey][i]);
                        ...
                        setZTreeTools: function(setting, zTreeTools) {
                            for (var i = 0,
                                     j = _init.zTreeTools.length; i < j; i++) _init.zTreeTools[i].apply(this, arguments)
                        },
                        transformToArrayFormat: function(setting, nodes) {
                            if (!nodes) return [];
                            var childKey = setting.data.key.children,
                                r = [];
                            if (tools.isArray(nodes)) for (var i = 0,
                                                               l = nodes.length; i < l; i++) r.push(nodes[i]),
                    ...
                    event = {
                        bindEvent: function(setting) {
                            for (var i = 0,
                                     j = _init.bind.length; i < j; i++) _init.bind[i].apply(this, arguments)
                        },
                        unbindEvent: function(setting) {
                            for (var i = 0,
                                     j = _init.unbind.length; i < j; i++) _init.unbind[i].apply(this, arguments)
                        },
                        bindTree: function(setting) {
                            var eventParam = {
                                ...
                                o = setting.treeObj;
                            setting.view.txtSelectedEnable || o.bind("selectstart",
                                function(e) {
                        ...
                        proxy: function(e) {
                            ...
                            for (var results = event.doProxy(e), r = !0, i = 0, l = results.length; i < l; i++) {
                                ...
                                proxyResult.nodeEventCallback && (!0, r = proxyResult.nodeEventCallback.apply(proxyResult, [e, proxyResult.node]) && r),
                                proxyResult.treeEventCallback && (!0, r = proxyResult.treeEventCallback.apply(proxyResult, [e, proxyResult.node]) && r)
                            }
                            return r
                        }
                    },
                    ...
                    tools = {
                        ...
                        $: function(node, exp, setting) {
                            return exp && "string" != typeof exp && (setting = exp, exp = ""),
                        ...
                        getMDom: function(setting, curDom, targetExpr) {
                            ...
                            for (; curDom && curDom.id !== setting.treeId;) {
                                for (var i = 0,
                                         l = targetExpr.length; curDom.tagName && i < l; i++) if (tools.eqs(curDom.tagName, targetExpr[i].tagName) && null !== curDom.getAttribute(targetExpr[i].attrName)) return curDom;
                    ...
                    view = {
                        addNodes: function(setting, parentNode, newNodes, isSilent) {
                            if (!setting.data.keep.leaf || !parentNode || parentNode.isParent) if (tools.isArray(newNodes) || (newNodes = [newNodes]), setting.data.simpleData.enable && (newNodes = data.transformTozTreeFormat(setting, newNodes)), parentNode) {
                                ...
                                parentNode.open || (view.replaceSwitchClass(parentNode, target_switchObj, consts.folder.CLOSE), view.replaceIcoClass(parentNode, target_icoObj, consts.folder.CLOSE), parentNode.open = !1, target_ulObj.css({
                                    display: "none"
                                })),
                        ...
                        appendParentULDom: function(setting, node) {
                            var html = [],
                                nObj = $$(node, setting); ! nObj.get(0) && node.parentTId && (view.appendParentULDom(setting, node.getParentNode()), nObj = $$(node, setting));
                        ...
                        asyncNode: function(setting, node, isSilent, callback) {
                            ...
                            if (tools.isArray(setting.async.otherParam)) for (i = 0, l = setting.async.otherParam.length; i < l; i += 2) tmpParam[setting.async.otherParam[i]] = setting.async.otherParam[i + 1];
                        ...
                        expandCollapseSonNode: function(setting, node, expandFlag, animateFlag, callback) {
                            ...
                            if (data.getRoot(setting).expandTriggerFlag = !1, treeNodes) for (var i = 0,
                                                                                                  l = treeNodes.length; i < l; i++) treeNodes[i] && view.expandCollapseSonNode(setting, treeNodes[i], expandFlag, selfAnimateSign);
                        ...
                        makeNodeIcoClass: function(setting, node) {
                            ...
                            } else icoCss[0] = (node.iconSkin ? node.iconSkin + "_": "") + icoCss[0],
                        ...
                        removeChildNodes: function(setting, node) {
                            if (node) {
                                ...
                                if (nodes) {
                                    for (var i = 0,
                                             l = nodes.length; i < l; i++) data.removeNodeCache(setting, nodes[i]);
                                    if (data.removeSelectedNode(setting), delete node[childKey], setting.data.keep.parent) $$(node, consts.id.UL, setting).empty();
                                    else {
                                        node.isParent = !1,
                                            node.open = !1;
                        ...
                        removeNode: function(setting, node) {
                            ...
                            if (node.isFirstNode = !1, node.isLastNode = !1, node.getPreNode = function() {
                                ...
                                $$(node, setting).remove(),
                                    ...
                                    data.removeSelectedNode(setting, node);
                                for (var i = 0,
                                         l = parentNode[childKey].length; i < l; i++) if (parentNode[childKey][i].tId == node.tId) {
                                ...
                                if (setting.data.keep.parent || 0 != childLength) {
                                    if (setting.view.showLine && childLength > 0) {
                                        ...
                                        if (tmp_ulObj = $$(newLast, consts.id.UL, setting), tmp_switchObj = $$(newLast, consts.id.SWITCH, setting), tmp_icoObj = $$(newLast, consts.id.ICON, setting), parentNode == root) if (1 == parentNode[childKey].length) view.replaceSwitchClass(newLast, tmp_switchObj, consts.line.ROOT);
                                        else {
                        ...
                        selectNode: function(setting, node, addFlag) {
                            ...
                            currentSelectA.prev("span").hasClass("center_close") && ($("." + consts.node.SELECTLI).removeClass(consts.node.SELECTLI), currentSelectA.parent().addClass(consts.node.SELECTLI)),
                        ...
                        switchNode: function(setting, node) {
                            if (node.open || !tools.canAsync(setting, node)) view.expandCollapseNode(setting, node, !node.open);
                ...
                $.fn.zTree = {
                    ...
                    destroy: function(treeId) {
                        if (treeId && treeId.length > 0) view.destroy(data.getSetting(treeId));
                    ...
                    init: function(obj, zSetting, zNodes) {
                        ...
                        var zTreeTools = {
                            ...
                            expandNode: function(node, expandFlag, sonSign, focus, callbackFlag) {
                                ...
                                if (data.getRoot(setting).expandTriggerFlag = callbackFlag, !tools.canAsync(setting, node) && sonSign) view.expandCollapseSonNode(setting, node, expandFlag, !0,
                                    function() {
                                        if (!1 !== focus) try {
                            ...
                            getNodeIndex: function(node) {
                                if (!node) return null;
                                for (var childKey = setting.data.key.children,
                                         parentNode = node.parentTId ? node.getParentNode() : data.getRoot(setting), i = 0, l = parentNode[childKey].length; i < l; i++) if (parentNode[childKey][i] == node) return i;
                                return - 1
                            },
                            ...
                            reAsyncChildNodes: function(parentNode, reloadType, isSilent) {
                                if (this.setting.async.enable) {
                                    ...
                                    if (isRoot && (parentNode = data.getRoot(setting)), "refresh" == reloadType) {
                                        for (var childKey = this.setting.data.key.children,
                                                 i = 0,
                                                 l = parentNode[childKey] ? parentNode[childKey].length: 0; i < l; i++) data.removeNodeCache(setting, parentNode[childKey][i]);
                                        if (data.removeSelectedNode(setting), parentNode[childKey] = [], isRoot) this.setting.treeObj.empty();
                                        else {
                            ...
                            selectNode: function(node, addFlag) {
                                if (node && tools.uCanDo(setting)) {
                                    if (addFlag = setting.view.selectedMulti && addFlag, node.parentTId) view.expandCollapseParentNode(setting, node.getParentNode(), !0, !1,
                                        function() {
                                            try {
                                                $$(node, setting).focus().blur()
                                            } catch(e) {}
            ...
            function($) {
                var _consts = {
                    ...
                    _zTreeTools = function(setting, zTreeTools) {
                        zTreeTools.checkNode = function(node, checked, checkTypeFlag, callbackFlag) {
                            ...
                            if (!0 !== node.chkDisabled && (!0 !== checked && !1 !== checked && (checked = !node[checkedKey]), callbackFlag = !!callbackFlag, (node[checkedKey] !== checked || checkTypeFlag) && (!callbackFlag || 0 != tools.apply(this.setting.callback.beforeCheck, [this.setting.treeId, node], !0)) && tools.uCanDo(this.setting) && this.setting.check.enable && !0 !== node.nocheck)) {
                                ...
                                var checkObj = $$(node, consts.id.CHECK, this.setting); (checkTypeFlag || this.setting.check.chkStyle === consts.radio.STYLE) && view.checkNodeRelation(this.setting, node),
                    ...
                    _data = {
                        ...
                        getTreeCheckedNodes: function(setting, nodes, checked, results) {
                            ...
                            results = results || [];
                            for (var i = 0,
                                     l = nodes.length; i < l && (!0 === nodes[i].nocheck || !0 === nodes[i].chkDisabled || nodes[i][checkedKey] != checked || (results.push(nodes[i]), !onlyOne)) && (data.getTreeCheckedNodes(setting, nodes[i][childKey], checked, results), !(onlyOne && results.length > 0)); i++);
                            return results
                        },
                        getTreeChangeCheckedNodes: function(setting, nodes, results) {
                            ...
                            results = results || [];
                            for (var i = 0,
                                     l = nodes.length; i < l; i++) ! 0 !== nodes[i].nocheck && !0 !== nodes[i].chkDisabled && nodes[i][checkedKey] != nodes[i].checkedOld && results.push(nodes[i]),
                    ...
                    _view = {
                        checkNodeRelation: function(setting, node) {
                            ...
                            if (setting.check.chkStyle == r.STYLE) {
                                ...
                                if (node[checkedKey]) if (setting.check.radioType == r.TYPE_ALL) {
                                    for (i = checkedList.length - 1; i >= 0; i--) pNode = checkedList[i],
                                    pNode[checkedKey] && pNode != node && (pNode[checkedKey] = !1, checkedList.splice(i, 1), view.setChkClass(setting, $$(pNode, consts.id.CHECK, setting), pNode), pNode.parentTId != node.parentTId && view.repairParentChkClassWithSelf(setting, pNode));
                                    checkedList.push(node)
                                } else {
                                    var parentNode = node.parentTId ? node.getParentNode() : data.getRoot(setting);
                                    for (i = 0, l = parentNode[childKey].length; i < l; i++) pNode = parentNode[childKey][i],
                                    pNode[checkedKey] && pNode != node && (pNode[checkedKey] = !1, view.setChkClass(setting, $$(pNode, consts.id.CHECK, setting), pNode))
                                } else if (setting.check.radioType == r.TYPE_ALL) for (i = 0, l = checkedList.length; i < l; i++) if (node == checkedList[i]) {
                                    checkedList.splice(i, 1);
                                    break
                                }
                            } else node[checkedKey] && (!node[childKey] || 0 == node[childKey].length || setting.check.chkboxType.Y.indexOf("s") > -1) && view.setSonNodeCheckBox(setting, node, !0),
                        ...
                        repairAllChk: function(setting, checked) {
                            if (setting.check.enable && setting.check.chkStyle === consts.checkbox.STYLE) for (var checkedKey = setting.data.key.checked,
                                                                                                                   childKey = setting.data.key.children,
                                                                                                                   root = data.getRoot(setting), i = 0, l = root[childKey].length; i < l; i++) {
                                var node = root[childKey][i]; ! 0 !== node.nocheck && !0 !== node.chkDisabled && (node[checkedKey] = checked),
                        ...
                        repairSonChkDisabled: function(setting, node, chkDisabled, inherit) {
                            if (node) {
                                var childKey = setting.data.key.children;
                                if (node.chkDisabled != chkDisabled && (node.chkDisabled = chkDisabled), view.repairChkClass(setting, node), node[childKey] && inherit) for (var i = 0,
                                                                                                                                                                                 l = node[childKey].length; i < l; i++) {
                        ...
                        setSonNodeCheckBox: function(setting, node, value, srcNode) {
                            if (node) {
                                ...
                                var hasDisable = !1;
                                if (node[childKey]) for (var i = 0,
                                                             l = node[childKey].length; i < l && !0 !== node.chkDisabled; i++) {
                                    var sNode = node[childKey][i];
                ...
                view.removeNode = function(setting, node) {
                    ...
                    node && parentNode && (view.repairChkClass(setting, parentNode), view.repairParentChkClass(setting, parentNode))
                };
                ...
                var _consts = {
                    ...
                    _zTreeTools = function(setting, zTreeTools) {
                        zTreeTools.cancelEditName = function(newName) {
                            ...
                            zTreeTools.copyNode = function(targetNode, node, moveType, isSilent) {
                                ...
                                return targetNode || (targetNode = null, moveType = consts.move.TYPE_INNER),
                                    moveType == consts.move.TYPE_INNER ? tools.canAsync(this.setting, targetNode) ? view.asyncNode(this.setting, targetNode, isSilent, copyCallback) : copyCallback() : (view.addNodes(this.setting, targetNode.parentNode, [newNode], isSilent), view.moveNode(this.setting, targetNode, newNode, moveType, !1, isSilent)),
                                    newNode
                            },
                    ...
                    _data = {
                        setSonNodeLevel: function(setting, parentNode, node) {
                            if (node) {
                                var childKey = setting.data.key.children;
                                if (node.level = parentNode ? parentNode.level + 1 : 0, node[childKey]) for (var i = 0,
                                                                                                                 l = node[childKey].length; i < l; i++) node[childKey][i] && data.setSonNodeLevel(setting, node, node[childKey][i])
                            }
                        }
                    },
                    _event = {},
                        ...
                        onMousedownNode: function(eventMouseDown, _node) {
                            function _docMouseMove(event) {
                                ...
                                if (body.css("cursor", "pointer"), 0 == root.dragFlag) {
                                    if (0 == tools.apply(setting.callback.beforeDrag, [setting.treeId, nodes], !0)) return _docMouseUp(event),
                                        !0;
                                    for (i = 0, l = nodes.length; i < l; i++) 0 == i && (root.dragNodeShowBefore = []),
                                        tmpNode = nodes[i],
                                        tmpNode.isParent && tmpNode.open ? (view.expandCollapseNode(setting, tmpNode, !tmpNode.open), root.dragNodeShowBefore[tmpNode.tId] = !0) : root.dragNodeShowBefore[tmpNode.tId] = !1;
                                    root.dragFlag = 1,
                                    ...
                                    for (isOrder && (preNode = nodes[0].getPreNode(), nextNode = nodes[nodes.length - 1].getNextNode()), curNode = $$("<ul class='zTreeDragUL'></ul>", setting), i = 0, l = nodes.length; i < l; i++) tmpNode = nodes[i],
                                        tmpNode.editNameFlag = !1,
                                        view.selectNode(setting, tmpNode, i > 0),
                                        view.removeTreeDom(setting, tmpNode),
                                    i > setting.edit.drag.maxShowNodeNum - 1 || (tmpDom = $$("<li id='" + tmpNode.tId + "_tmp'></li>", setting), tmpDom.append($$(tmpNode, consts.id.A, setting).clone()), tmpDom.css("padding", "0"), tmpDom.children("#" + tmpNode.tId + consts.id.A).removeClass(consts.node.CURSELECTED), curNode.append(tmpDom), i == setting.edit.drag.maxShowNodeNum - 1 && (tmpDom = $$("<li id='" + tmpNode.tId + "_moretmp'><a>  ...  </a></li>", setting), curNode.append(tmpDom)));
                                ...
                                if (1 == root.dragFlag) {
                                    ...
                                    if (tmpTarget && tmpTarget.attr("id") != targetSetting.treeId) {
                                        ...
                                        if (canPrev || canNext || canInner) {
                                            ...
                                            if ((1 == prevPercent || dY_percent <= prevPercent && dY_percent >= -.2) && canPrev ? (dX = 1 - tmpArrow.width(), dY = tmpTop - tmpArrow.height() / 2, moveType = consts.move.TYPE_PREV) : (0 == nextPercent || dY_percent >= nextPercent && dY_percent <= 1.2) && canNext ? (dX = 1 - tmpArrow.width(), dY = null == tmpNextA || tmpTargetNode.isParent && tmpTargetNode.open ? tmpTop + tmpTargetA.height() - tmpArrow.height() / 2 : tmpNextA.offset().top - tmpArrow.height() / 2, moveType = consts.move.TYPE_NEXT) : (dX = 5 - tmpArrow.width(), dY = tmpTop, moveType = consts.move.TYPE_INNER), tmpArrow.css({
                                                ...
                                                var startTimer = !0;
                                                window.zTreeMoveTimer && window.zTreeMoveTargetNodeTId !== tmpTargetNode.tId ? (clearTimeout(window.zTreeMoveTimer), window.zTreeMoveTargetNodeTId = null) : window.zTreeMoveTimer && window.zTreeMoveTargetNodeTId === tmpTargetNode.tId && (startTimer = !1),
                                    ...
                                    } else moveType = consts.move.TYPE_INNER,
                            ...
                            function _docMouseUp(event) {
                                function dropCallback() {
                                    if (isOtherTree) {
                                        if (!isCopy) for (var i = 0,
                                                              l = nodes.length; i < l; i++) view.removeNode(setting, nodes[i]);
                                        if (moveType == consts.move.TYPE_INNER) view.addNodes(targetSetting, dragTargetNode, newNodes);
                                        else if (view.addNodes(targetSetting, dragTargetNode.getParentNode(), newNodes), moveType == consts.move.TYPE_PREV) for (i = 0, l = newNodes.length; i < l; i++) view.moveNode(targetSetting, dragTargetNode, newNodes[i], moveType, !1);
                                        else for (i = -1, l = newNodes.length - 1; i < l; l--) view.moveNode(targetSetting, dragTargetNode, newNodes[l], moveType, !1)
                                    } else if (isCopy && moveType == consts.move.TYPE_INNER) view.addNodes(targetSetting, dragTargetNode, newNodes);
                                    else if (isCopy && view.addNodes(targetSetting, dragTargetNode.getParentNode(), newNodes), moveType != consts.move.TYPE_NEXT) for (i = 0, l = newNodes.length; i < l; i++) view.moveNode(targetSetting, dragTargetNode, newNodes[i], moveType, !1);
                                    else for (i = -1, l = newNodes.length - 1; i < l; l--) view.moveNode(targetSetting, dragTargetNode, newNodes[l], moveType, !1);
                                ...
                                if (window.zTreeMoveTimer && (clearTimeout(window.zTreeMoveTimer), window.zTreeMoveTargetNodeTId = null), preTmpTargetNodeId = null, preTmpMoveType = null, doc.unbind("mousemove", _docMouseMove), doc.unbind("mouseup", _docMouseUp), doc.unbind("selectstart", _docSelect), body.css("cursor", "auto"), tmpTarget && (tmpTarget.removeClass(consts.node.TMPTARGET_TREE), tmpTargetNodeId && $("#" + tmpTargetNodeId + consts.id.A, tmpTarget).removeClass(consts.node.TMPTARGET_NODE + "_" + consts.move.TYPE_PREV).removeClass(consts.node.TMPTARGET_NODE + "_" + _consts.move.TYPE_NEXT).removeClass(consts.node.TMPTARGET_NODE + "_" + _consts.move.TYPE_INNER)), tools.showIfameMask(setting, !1), roots.showHoverDom = !0, 0 != root.dragFlag) {
                                    root.dragFlag = 0;
                                    var i, l, tmpNode;
                                    for (i = 0, l = nodes.length; i < l; i++) tmpNode = nodes[i],
                                    tmpNode.isParent && root.dragNodeShowBefore[tmpNode.tId] && !tmpNode.open && (view.expandCollapseNode(setting, tmpNode, !tmpNode.open), delete root.dragNodeShowBefore[tmpNode.tId]);
                                    ...
                                    } else view.selectNodes(sourceSetting, nodes),
                    ...
                    _tools = {
                        ...
                        setCursorPosition: function(obj, pos) {
                            if (obj.setSelectionRange) obj.focus(),
                        ...
                        showIfameMask: function(setting, showSign) {
                            for (var root = data.getRoot(setting); root.dragMaskList.length > 0;) root.dragMaskList[0].remove(),
                    ...
                    _view = {
                        ...
                        moveNode: function(setting, targetNode, node, moveType, animateFlag, isSilent) {
                            ...
                            if (targetNode != node && (!setting.data.keep.leaf || !targetNode || targetNode.isParent || moveType != consts.move.TYPE_INNER)) {
                                ...
                                moveType == consts.move.TYPE_INNER && (targetNodeIsRoot ? node.parentTId = null: (targetNode.isParent || (targetNode.isParent = !0, targetNode.open = !!targetNode.open, view.setNodeLineIcos(setting, targetNode)), node.parentTId = targetNode.tId));
                                var targetObj, target_ulObj;
                                if (targetNodeIsRoot) targetObj = setting.treeObj,
                                ...
                                var i, l, tmpSrcIndex = -1,
                                    ...
                                    newNeighbor = null,
                                    oldLevel = node.level;
                                if (node.isFirstNode) tmpSrcIndex = 0,
                                oldParentNode[childKey].length > 1 && (oldNeighbor = oldParentNode[childKey][1], oldNeighbor.isFirstNode = !0);
                                else if (node.isLastNode) tmpSrcIndex = oldParentNode[childKey].length - 1,
                                    oldNeighbor = oldParentNode[childKey][tmpSrcIndex - 1],
                                    oldNeighbor.isLastNode = !0;
                                else for (i = 0, l = oldParentNode[childKey].length; i < l; i++) if (oldParentNode[childKey][i].tId == node.tId) {
                                        tmpSrcIndex = i;
                                        break
                                    }
                                ...
                                setting.check && setting.check.enable && view.repairChkClass && (view.repairChkClass(setting, oldParentNode), view.repairParentChkClassWithSelf(setting, oldParentNode), oldParentNode != node.parent && view.repairParentChkClassWithSelf(setting, node)),
                        ...
                        selectNodes: function(setting, nodes) {
                            for (var i = 0,
                                     l = nodes.length; i < l; i++) view.selectNode(setting, nodes[i], i > 0)
                        }
                    },
                    _z = {
                        tools: _tools,
        ...
        function(module, exports) {
            window.ZtreeCreator = function(treeId, url, initJson) {
                ...
                this.initZtree = function(param, level, callBack) {
                    ...
                    jQuery.isFunction(param) && (callBack = param, param = {}),
                    jQuery.isFunction(level) && (callBack = level, level = !1),
                    param || (param = {}),
                        initJson ? (pushJsonToBuildTree(initJson, level, callBack), this) : _setting.async.url ? (_treeObj = jQuery.fn.zTree.init(jQuery("#" + treeId), _setting), this) : (jQuery.post(url, param,
                            function(result) {
                    ...
                    this.setCallback = function(callBack) {
                        if (callBack instanceof Object) for (call in callBack) jQuery.isFunction(callBack[call]) || alert(call + " :is not a function"),
