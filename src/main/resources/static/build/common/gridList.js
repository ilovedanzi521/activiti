                    ...
                    BootstrapTable.DEFAULTS = {
                                ...
                                this.$el.find(">tbody>tr").each(function (y) {
                                    ...
                                    row._id = $(this).attr("id"),
                                        ...
                                        $(this).find(">td").each(function (x) {
                                            ...
                                            for (tx = x; tx < x + cspan; tx++) for (ty = y; ty < y + rspan; ty++) m[ty] || (m[ty] = []),
                                                m[ty][tx] = !0;
                        ...
                        BootstrapTable.prototype.initHeader = function () {
                            ...
                            this.header = {
                                    ...
                                    0 === i && !that.options.cardView && that.options.detailView && html.push(sprintf('<th class="detail" rowspan="%s"><div class="fht-cell"></div></th>', that.options.columns.length)),
                                        $.each(columns, function (j, column) {
                                            var text = "",
                                                ...
                                                unitWidth = (that.options.sortOrder || column.order, "px"),
                                                width = column.width;
                                            ...
                                            html.push("<th" + sprintf(' title="%s"', column.titleTooltip), column.checkbox || column.radio ? sprintf(' class="bs-checkbox %s"', column.class || "") : class_, sprintf(' style="%s"', halign + style), sprintf(' rowspan="%s"', column.rowspan), sprintf(' colspan="%s"', column.colspan), sprintf(' data-field="%s"', column.field), "tabindex='0'", ">"),
                                                ...
                                                text = column.title,
                                            column.checkbox && (!that.options.singleSelect && that.options.checkboxHeader && (text = '<input name="btSelectAll" type="checkbox" />'), that.header.stateField = column.field),
                                            column.radio && (text = "", that.header.stateField = column.field, that.options.singleSelect = !0),
                                                html.push(text),
                                                html.push("</div>"),
                                ...
                                !this.options.showHeader || this.options.cardView ? (this.$header.hide(), this.$tableHeader.hide(), this.$tableLoading.css("top", 0)) : (this.$header.show(), this.$tableHeader.show(), this.$tableLoading.css("top", this.$header.outerHeight() + 1), this.getCaret(), $(window).on("resize.bootstrap-table", $.proxy(this.resetWidth, this))),
                        ...
                        BootstrapTable.prototype.initSort = function () {
                            ...
                            if (this.options.customSort !== $.noop) return void this.options.customSort.apply(this, [this.options.sortName, this.options.sortOrder]); - 1 !== index && (this.options.sortStable && $.each(this.data, function (i, row) {
                        ...
                        BootstrapTable.prototype.onSearch = function (event) {
                            ...
                            text !== this.searchText && (this.searchText = text, this.options.searchText = text, this.options.pageNumber = 1, this.initSearch(), this.updatePagination(), this.trigger("search", text))
                        },
                                ...
                                this.data = f ? $.grep(this.options.data, function (item, i) {
                                    ...
                                    this.data = s ? $.grep(this.data, function (item, i) {
                                        for (var j = 0; j < that.header.fields.length; j++) if (that.header.searchables[j]) {
                                            var value, key = $.isNumeric(that.header.fields[j]) ? parseInt(that.header.fields[j], 10) : that.header.fields[j],
                        ...
                        BootstrapTable.prototype.initPagination = function () {
                            ...
                            var i, from, to, $pageList, $first, $pre, $next, $last, $number, that = this,
                                html = [],
                                $allSelected = !1,
                                data = this.getData(),
                        ...
                        BootstrapTable.prototype.initBody = function (fixedScroll) {
                            ...
                            this.options.pagination && "server" !== this.options.sidePagination || (this.pageFrom = 1, this.pageTo = data.length);
                            ...
                            fixedScroll || this.scrollTo(0),
                                ...
                                this.$body.find("> tr[data-index] > td > .detail-icon").off("click").on("click", function () {
                                    var $this = $(this),
                                        ...
                                        index = $tr.data("index"),
                                        row = data[index];
                                    if ($tr.next().is("tr.detail-view")) $this.find("i").attr("class", sprintf("%s %s", that.options.iconsPrefix, that.options.icons.detailOpen)),
                                        $tr.next().remove(),
                        ...
                        BootstrapTable.prototype.initServer = function (silent, query, url) {
                            ...
                            this.options.pagination && (params.pageSize = this.options.pageSize === this.options.formatAllRows() ? this.options.totalRows : this.options.pageSize, params.pageNumber = this.options.pageNumber),
                        ...
                        BootstrapTable.prototype.fitHeader = function () {
                            ...
                            focusedTemp.length > 0 && (focusedTemp.focus(), this.$header.find(".focus-temp").removeClass("focus-temp")),
                                this.$header.find("th[data-field]").each(function (i) {
                        ...
                        BootstrapTable.prototype.resetView = function (params) {
                            ...
                            if (this.options.cardView) return this.$el.css("margin-top", "0"),
                                this.$tableContainer.css("padding-bottom", "0"),
                                void this.$tableFooter.hide();
                            this.options.showHeader && this.options.height ? (this.$tableHeader.show(), this.resetHeader(), padding += this.$header.outerHeight()) : (this.$tableHeader.hide(), this.trigger("post-header")),
                            this.options.showFooter && (this.resetFooter(), this.options.height && (padding += this.$tableFooter.outerHeight() + 1)),
                                this.getCaret(),
                        ...
                        BootstrapTable.prototype.load = function (data) {
                            var fixedScroll = !1;
                            "server" === this.options.sidePagination ? (this.options.totalRows = data.total, fixedScroll = data.fixedScroll, data = data[this.options.dataField]) : $.isArray(data) || (fixedScroll = data.fixedScroll, data = data.data),
                                this.initData(data),
                                this.initSearch(),
                                this.initPagination(),
                        ...
                        BootstrapTable.prototype.remove = function (params) {
                            ...
                            if (params.hasOwnProperty("field") && params.hasOwnProperty("values")) {
                                for (i = len - 1; i >= 0; i--) row = this.options.data[i],
                        ...
                        BootstrapTable.prototype.getRowByUniqueId = function (id) {
                            var i, row, rowUniqueId, uniqueId = this.options.uniqueId,
                                len = this.options.data.length,
                                dataRow = null;
                            for (i = len - 1; i >= 0; i--) {
                                if (row = this.options.data[i], row.hasOwnProperty(uniqueId)) rowUniqueId = row[uniqueId];
                                else {
                        ...
                        BootstrapTable.prototype.removeByUniqueId = function (id) {
                            ...
                            len !== this.options.data.length && (this.initSearch(), this.initPagination(), this.initBody(!0))
                        },
                        ...
                        BootstrapTable.prototype.collapseAllRows = function (isSubTable) {
                            if (isSubTable) this.expandRow_(!1, 0);
                            else for (var trs = this.$body.children(), i = 0; i < trs.length; i++) this.expandRow_(!1, $(trs[i]).data("index"))
                        },
            ...
            function initQtip() {
                $("body").delegate("[qtip]", "mouseover", function () {
                    var qtipApi = $(this).qtip("api"),
                        msg = $(this).attr("qtip");
                    if (qtipApi) qtipApi.disabled && qtipApi.enable();
                    else {
                        var defaultSetting = {
                            show: {
                                solo: !0
                        ...
                        $.handlerRemoveSelect = function () {
                            ...
                            $obj.unbind("click"),
                                $obj.bind("click", function () {
                                    ...
                                    if (null == ids || ids.length < 1) return $.Dialog.msg("请选择记录!"),
                                        !1;
                                    if (null == url || "" == url) return $.Dialog.msg("请配置删除 URL!"),
                                        !1;
                                    url = $.getUrl(url);
                                    var param = {};
                        ...
                        $.handlerCollapseExpand = function () {
                            ...
                            $obj.unbind("click"),
                                $obj.bind("click", function () {
                                    ...
                                    me.hasClass("expand") ? (me.attr("title", "收缩"), me.removeClass("expand").addClass("collapse"), me.removeClass("fa-angle-double-down").addClass("fa-angle-double-up"), el.slideDown(200)) : (me.attr("title", "展开"), me.removeClass("collapse").addClass("expand"), me.removeClass("fa-angle-double-up").addClass("fa-angle-double-down"), el.slideUp(200)),
                        ...
                        $("[sysTreeGroup]").each(function (index, item) {
                            ...
                            var callbackFun = function (event, treeId, treeNode) {
                                $("[ab-grid]").bootstrapTable("refreshOptions", {
                                    queryParams: function (params) {
                                        return params[groupColumn + "^VEQ"] = treeNode.id,
                                            params
                                    }
                                })
                            };
