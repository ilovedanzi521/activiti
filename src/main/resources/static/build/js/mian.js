            ...
            $http({
                ...
                for (var stencilIndex = 0; stencilIndex < data.stencils.length; stencilIndex++) {
                    ...
                    if ("Diagram" !== currentGroupName && "Form" !== currentGroupName) {
                        ...
                        data.stencils[stencilIndex].customIconId && 0 < data.stencils[stencilIndex].customIconId && (stencilItem.customIcon = !0, stencilItem.icon = data.stencils[stencilIndex].customIconId),
                        removed || 0 <= quickMenuDefinition.indexOf(stencilItem.id) && (quickMenuItems[quickMenuDefinition.indexOf(stencilItem.id)] = stencilItem),
                        "TextAnnotation" !== stencilItem.id && "BoundaryCompensationEvent" !== stencilItem.id || (stencilItem.canConnectAssociation = !0);
            ...
            scope.testSelect = function (e) {
                ...
                scope.addNodeUserCondition = function (e, n) {
                    ...
                    var s = {
                        ...
                        btnAlign: "c",
                        title: "人员条件配置",
                        url: "/bpm/nodeDef/userConditionDialog.html?defId=" + "vacationProcess:7:35004" + "&nodeId=" + i + "&nodeType=" + t,
                        ok: function (e, t) {
                            var i = t.getData();
                            i && (scope.$apply(function () {
