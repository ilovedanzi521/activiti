    ...
    <div class="ProductInfo">
        ...
        <div class="formInline">
            <win_form v-model="productInfoForm" :inline="true">
                <win_row>
                    <win_col class="buttonCol">
                        <el-button-group>
                            <win_button type="info" icon="el-icon-plus" @click="onAddSubmit" round>新增</win_button>
                            <win_button type="info" icon="el-icon-delete" :disabled="multipleSelection.length == 0" round>导出</win_button>
                            <win_button type="info" icon="el-icon-document-copy" round>导出所有</win_button>
                        </el-button-group>
                    </win_col>
                    <win_col class="inCol">
        ...
        <div class="fundDataTable">
            <win_table :height="tableHeight" highlight-current-row @cell-click="handleCurrentChange" :data="pageVO.list" @select-all="handleSelectAll" ref="fundInfoTable" @cell-dblclick="handleRowDBClick"
                ...
                <win_table_column prop="prodShare" :thousandth="true" label="产品份额" align="right" min-width="180"></win_table_column>
                ...
                <win_table_column prop="createTime" :formatter="DateFormatter" label="录入时间" align="left" min-width="150"></win_table_column>
                <win_table_column prop="updateUserId" label="最近修改人" align="left" min-width="150"></win_table_column>
                <win_table_column prop="updateTime" :formatter="DateFormatter" label="最近修改时间" align="left" min-width="150"></win_table_column>
