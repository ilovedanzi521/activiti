    ...
    <div class="rightRole-contanier">
        <div class="text-contanier">
            ...
            <div class="roleRole-buttonGrounp">
                ...
                <win_button @click="addRoleRight" type="primary">确定</win_button>
            </div>
        </div>
...
@Component({
    components: { win_table, win_table_column, win_button }
})
export default class RoleRight extends RoleController {
    ...
    checked(first, second, three, four) {
        ...
        this.checkRoleRightArray.push(s);
    }
    ...
    addRoleRight() {
        ...
        this.$emit("addRoleRight", this.checkArray);
        this.closeRole();
    }

    mounted() {
        // this.getCheckRoleItem(this.roleRightArray);
    }
}
</script>
