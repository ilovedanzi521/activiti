    ...
    <div class="divCenter">
      <div class="buttons">
        ...
        <span v-if="dialogVO.action === 1">
          <win_button @click="addExchangeRate('exchangeForm')" type="primary">确认</win_button>
        </span>
        <span v-else-if="dialogVO.action === 2">
          <win_button @click="updateExchangeRate('exchangeForm')" type="primary">确认</win_button>
        </span>
        <span v-else>
          <win_button @click="deleteExchangeRate('exchangeForm')" type="primary">确认</win_button>
        </span>
      </div>
    </div>
  </win_dialog>
