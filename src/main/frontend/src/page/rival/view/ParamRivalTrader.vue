<template>
  <div>
    ...
    <win_table :data="pageVO.list" @cell-dblclick="dblclick" @select-change="tableSelectionChange" @select-all="tableSelectionChange" max-height="145px">
      <win_table_column prop="traderName" label="交易员" min-width="100"></win_table_column>
      <win_table_column prop="phone" label="联系方式" min-width="100"></win_table_column>
      <win_table_column prop="qq" label="QQ" min-width="100"></win_table_column>
      <win_table_column prop="email" label="邮箱" min-width="150"></win_table_column>
      <win_table_column prop="remark" label="备注" min-width="150"></win_table_column>
      ...
      <win_table_column prop="createTime" label="操作时间" min-width="160" :formatter="formatDic"></win_table_column>
