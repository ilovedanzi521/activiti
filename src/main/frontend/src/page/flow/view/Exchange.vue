    ...
    <div class="container">
        ...
        <el-container>
            <el-aside width="212px">
                <div ref="userinfo">
                    <el-button-group>
                        <win_button :disabled="level!=1" type="warning" round @click="addflowgroup"><i class="el-icon-plus"></i> 新增</win_button>
                        <win_button type="warning" icon="el-icon-delete" round @click="delflowgroup">删除</win_button>
                    </el-button-group>
                ...
                <el-header height="165px">
                    ...
                    >
                        ...
                        <el-row style="margin-left:15px">
                            ...
                            <el-button-group>
                                <win_button :disabled="level!=2" type="warning" round @click="openAddDialog()"><i class="el-icon-plus"></i> 新增</win_button>
                                <win_button :disabled="level!=2||!options" type="warning" icon="el-icon-delete" round @click="batchDelete(tableChecked)">删除</win_button>
                                <win_button :disabled="level!=2||!options" type="warning" icon="el-icon-video-play" round @click="startflow(tableChecked)">启动</win_button>
                                <win_button :disabled="level!=2||!options" type="warning" icon="el-icon-video-pause" round @click="stopflow(tableChecked)">停止</win_button>
                            </el-button-group>
                        </el-row>
                    </win_form>
                </el-header>
                <!--返回数据列表-->
                <el-main style="height:800px;background-color: #000">
                    <div style="width:100%">
                        <win_table
                            :data="repFlowVOs"
        ...
        >
            ...
            <div>
                ...
                <span v-if="flowVO.id">
          <win_button
              @click="updateExchangeFlow('exchangeForm')"
              class="yellowButton"
          >确认</win_button>
        </span>
                <span v-else>
          <win_button
              @click="addExchangeFlow('exchangeForm')"
              class="yellowButton"
          >确认</win_button>
        </span>
            </div>
