    ...
    <div>
        ...
        <div>
            <win_table ref="table" :data="securityBasicInfo.list" @cell-dblclick="view" @select-all="handleSelectAll" @select-change="handleSelectChange" v-loading="loading" element-loading-text="拼命加载中..." indexFixed selectionFixed
                highlight-current-row max-height="440px">
                <win_table_column prop="securityCode" label="证券内码" header-align="center" align="left" sortable fixed="left" min-width="110"></win_table_column>
...
.el-table /deep/ .warning-row > td:not(:last-child) {
