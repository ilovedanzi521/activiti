<template>
    <div>
                ...
                <win_row>
                    ...
                    <win_col class="fcol">
                        <win_form_item label="交易市场">
                            <win_select v-model="formInline.marketType" clearable multiple placeholder="请选择">
                                <win_option v-for="item in paramRateChangeEntity.marketType" :key="item.dicCode" :label="item.dicExplain" :value="item.dicCode">
        ...
        <div>
            <win_table :data="interestRateChangeInfo.list" @select-all="handleSelectAll" @select-change="handleSelectChange" max-height="440px" v-loading="loading" @cell-dblclick="view" element-loading-text="拼命加载中...">
                <win_table_column prop="securityCode" label="证券代码" header-align="center" align="left" sortable min-width="150"></win_table_column>
                <win_table_column prop="securityName" label="证券名称" header-align="center" align="left" sortable min-width="200"></win_table_column>
                <win_table_column :formatter="marketTypeFormatter" prop="marketType" label="交易市场" header-align="center" align="left" sortable min-width="100"></win_table_column>
                <win_table_column prop="beginDate" label="开始日期" header-align="center" align="center" sortable :formatter="DateFormatter" min-width="120"></win_table_column>
                <win_table_column prop="endDate" label="结束日期" header-align="center" align="center" sortable :formatter="DateFormatter" min-width="120"></win_table_column>
