  ...
  <div class="BondRate" style="width:100%;">
    ...
    <div class="formInline">
      <win_form v-model="bondInfoForm" :inline="true" class="demo-form-inline">
        <win_row>
          ...
          <win_col class="fcol">
            <win_form_item label="交易市场">
              <win_select v-model="bondInfoForm.marketType" clearable multiple placeholder="请选择">
                <win_option v-for="item in bondDicData.marketType" :key="item.dicCode" :label="item.dicExplain" :value="item.dicCode">
          ...
          <win_col class="fcol">
            <win_form_item label="数据来源">
              <win_select v-model="bondInfoForm.dataSource" clearable multiple placeholder="请选择">
                <win_option v-for="item in bondDicData.dataSource" :key="item.dicCode" :label="item.dicExplain" :value="item.dicCode">
                  <span style="float: left">{{ item.dicCode }}</span>
                  <span>{{ "&nbsp;"+item.dicExplain }}</span>
                </win_option>
              </win_select>
    ...
    <div class="bondTateTable" style="width:100%;">
      <win_table max-height="440" highlight-current-row @select-change="handleSelectionChange" @select-all="handleSelectAll" @cell-dblclick="handleRowDBClick" :data="pageVO.list">
        ...
        <win_table_column sortable prop="securityName" label="证券名称" align="left" min-width="150"></win_table_column>
        <win_table_column :formatter="bondDicFormatter" sortable prop="marketType" label="交易市场" align="left" min-width="150"></win_table_column>
        ...
        <win_table_column prop="beginDate" label="开始日期" min-width="180" align="center" :formatter="DateFormatter"></win_table_column>
        <win_table_column prop="endDate" label="结束日期" min-width="180" align="center" :formatter="DateFormatter"></win_table_column>
        <win_table_column :formatter="bondDicFormatter" prop="dataSource" label="数据来源" min-width="180" align="center"></win_table_column>
